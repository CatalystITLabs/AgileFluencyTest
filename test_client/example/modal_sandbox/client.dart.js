...
$$.Answer = {"": ["points>", "text>", "explanation>", "_showEvent", "_hideEvent", "_skipEvent"],
 ...
 explain$3: function(selectedByUser, maxPoints, displayExplanationMode) {
  ...
  if (!(t1 === "") && displayExplanationMode === 1) {
    ...
    $.getInterceptor(t1).add$1(t1, new $.Answer_explain_anon(this, output));
    t1 = output.get$on().get$mouseOut();
    $.getInterceptor(t1).add$1(t1, new $.Answer_explain_anon0(answerText, output));
  }
  t1 = this.explanation;
  if (typeof t1 !== 'string')
  ...
  if (!(t1 === "") && displayExplanationMode === 2) {
    t1 = output.get$on().get$mouseOver();
    $.getInterceptor(t1).add$1(t1, new $.Answer_explain_anon1(this, output));
    t1 = output.get$on().get$mouseOut();
    $.getInterceptor(t1).add$1(t1, new $.Answer_explain_anon2(answerText, output));
  }
  t1 = this.explanation;
  if (typeof t1 !== 'string')
 ...
 toggleListener$3: function(step, button, modal) {
  ...
  if (this._showEvent == null)
    this._showEvent = new $.Answer_toggleListener_anon(modal, button, this);
  if (this._hideEvent == null)
    this._hideEvent = new $.Answer_toggleListener_anon0(modal, button, this);
  if (this._skipEvent == null)
    this._skipEvent = new $.Answer_toggleListener_anon1(modal, button, this);
  if (step === 1) {
...
$$.SingleSelect = {"": ["selected", "answers", "text", "explanation"],
 ...
 _makeButton$2: function(answer, number) {
  ...
  t1 = element.get$on().get$click();
  $.getInterceptor(t1).add$1(t1, new $.SingleSelect__makeButton_anon(number, this));
  return element;
},
 explain$0: function() {
...
$$.TestSection = {"": ["questions", "allQnA", "star", "name>", "description", "reference", "currentQuestion", "atSummary", "atExplanation", "finished", "explainCorrectQuestions"],
 ...
 summary$0: function() {
  ...
  passport.set$src("../3D/images/passport_m.png");
...
$$.XmlElement = {"": ["name>", "_liblib2$_children>", "_attributes", "_namespaces", "type", "parent"],
 "super": "XmlNode",
 get$text: function() {
  var t1, tNodes, s;
 ...
 addChild$1: function(element) {
  ...
  this._liblib2$_children._add$1(element);
},
 ...
 _queryAttributeInternal$2: function(aMap, list) {
  ...
  if (new $.XmlElement__queryAttributeInternal_checkAttribs(aMap, this).call$0() === true) {
    ...
    $.getInterceptor(t1).forEach$1(t1, new $.XmlElement__queryAttributeInternal_anon(aMap, list));
  }
},
 ...
 _queryNameInternal$2: function(tagName, list) {
  ...
  if ($.eqB(this.name, tagName)) {
    ...
    t1 = this.get$children().allElements$0();
    $.getInterceptor(t1).forEach$1(t1, new $.XmlElement__queryNameInternal_anon(tagName, list));
  }
},
...
$$.XmlParser = {"": ["_xml>", "_scopes>", "_withQuirks", "_root"],
    ...
    switch (tok.get$kind()) {
      ...
      case 4:
        if ($.getInterceptor(t1).get$isEmpty(t1) === true)
          ...
          this._parseTextNode$2(t, tok.get$_liblib2$_str());
          this._parseTag$1(t);
        }
        break;
    }
  ...
  for (; !(next == null);) {
    switch (next.get$kind()) {
      case 18:
        ...
        break;
      case 4:
        this._parseAttribute$2(t, next.get$_liblib2$_str());
        break;
      case 2:
 ...
 _parseTextNode$2: function(t, text) {
  ...
  t2 = new $.XmlParser__parseTextNode_writeStringNode(this, t1);
  t3 = t1.s_1;
 ...
 _parseNamespace$1: function(t) {
  ...
  name$ = t1.next_1.get$_liblib2$_str();
  t1.next_1 = t.next$0();
  this._assertKind$3(t1.next_1, 8, "Must have an = after a namespace name.");
  t1.next_1 = t.next$0();
  t4 = new $.XmlParser__parseNamespace_quotesRequired(name$, t, this, t3, t1);
  if (this._withQuirks === true) {
    ...
    if (t5 === 4)
      t3.call$2(name$, t2.get$_liblib2$_str());
    else if (t5 === 9)
      t4.call$0();
  } else
    t4.call$0();
        ...
        switch (state0) {
          ...
          case 2:
            if (state0 === 0 && $.eqB(t2, 4))
              t3.call$2(name$, t1.next_1.get$_liblib2$_str());
            else
              switch (state0) {
                case 0:
                  t2 = t1.next_1.get$kind();
 ...
 _parseAttribute$2: function(t, attributeName) {
  ...
  if (t3 === 6) {
    ...
    t1.attributeName_1 = $.S(t1.attributeName_1) + ":" + $.S(t1.next_2.get$_liblib2$_str());
    t1.next_2 = t.next$0();
  }
  ...
  if (this._withQuirks === true) {
    ...
    if (t5 === 4)
      t2.call$2(t1.attributeName_1, t4.get$_liblib2$_str());
    else if (t5 === 9)
      t3.call$0();
  } else
    t3.call$0();
        ...
        switch (state0) {
          ...
          case 4:
            if (state0 === 0 && $.eqB(t4, 4))
              t2.call$2(t1.attributeName_1, t1.next_2.get$_liblib2$_str());
            else
              switch (state0) {
                case 0:
...
$$.XmlTokenizer = {"": ["_specialTags", "_liblib2$_buffer>", "_tokenized", "_xml>", "_liblib2$_length>", "_i>", "_liblib2$_index"],
 "super": "Object",
  ...
  for (; t1.get$hasNext() === true;) {
    ...
    if ($.eqB(t2.get$kind(), token.get$kind()))
      if ($.eqB(t2.get$kind(), 4)) {
        if ($.eqB(t2.get$_liblib2$_str(), token.get$_liblib2$_str()))
          return i;
 ...
 _liblib2$_next$0: function() {
  ...
  t7 = this._liblib2$_buffer;
  if ($.getInterceptor(t7).get$isEmpty(t7) !== true)
    return t2.call$0();
  t7 = this._xml;
  while (true) {
    if ($.ltB(this._i, this._liblib2$_length)) {
  ...
  if ($.eqB(this._i, this._liblib2$_length))
    return;
 ...
 get$_liblib2$_next: function() { return new $.BoundClosure1(this, '_liblib2$_next$0'); },
 toString$0: function() {
 ...
 XmlTokenizer$1: function(_xml) {
  var t1, t;
  t1 = this._xml;
  this._liblib2$_length = $.getInterceptor(t1).get$length(t1);
...
$$.XmlToken = {"": ["kind>", "quoteKind>", "_liblib2$_str>", "_location="],
 "super": "Object",
 toString$0: function() {
  switch (this.kind) {
    case 16:
    ...
    case 3:
      return "(?)";
    case 4:
      return "STRING(" + $.S(this._liblib2$_str) + ")";
    case 5:
      return "(!)";
    case 6:
      return "(:)";
...
$$.XmlNode = {"": ["type>", "parent<"],
 ...
 remove$0: function() {
  ...
  if (t1 == null)
    return;
  t1 = t1.get$_liblib2$_children();
  i = $.getInterceptor(t1).indexOf$1(t1, this);
  if ($.eqB(i, -1))
    throw $.$$throw($.CTC21);
  this.parent.get$_liblib2$_children()._removeRange$2(i, 1);
},
 toString$0: function() {
...
$$.XmlCollection = {"": ["_collection"],
 ...
 _queryAttributeInternal$3: function(aMap, list, n) {
  var t1;
  if (new $.XmlCollection__queryAttributeInternal_checkAttribs(n, aMap).call$0() === true) {
    list._add$1(n);
    return;
  } else if (n.get$hasChildren() === true) {
    t1 = n.get$children().allElements$0();
    $.getInterceptor(t1).forEach$1(t1, new $.XmlCollection__queryAttributeInternal_anon(list, aMap));
  }
},
 _queryNodeTypeInternal$3: function(nodeType, list, node) {
  ...
  if ($.eqB(node.get$type(), nodeType)) {
    ...
    $.getInterceptor(t1).forEach$1(t1, new $.XmlCollection__queryNodeTypeInternal_anon(nodeType, list));
  }
},
 ...
 _queryAllNamesInternal$3: function(tagName, list, element) {
  ...
  if (element.get$hasChildren() === true) {
    ...
    $.getInterceptor(t1).forEach$1(t1, new $.XmlCollection__queryAllNamesInternal_anon0(tagName, list));
  }
},
...
$$.Camera = {"": ["viewBox", "scene>", "scale", "position", "rotation"],
 ...
 lookAtSlide$2: function(slide, time) {
  var t1, xOffset, yOffset, t2, t3, t4, t5;
  t1 = slide.element;
  xOffset = $.tdiv(t1.get$clientWidth(), 2);
  yOffset = $.tdiv(t1.get$clientHeight(), 2);
  t2 = $.add(slide.position.get$x(), xOffset);
  t3 = $.add(slide.position.get$y(), yOffset);
  t4 = slide.position.get$z();
  t5 = slide.rotation;
  this.move$7(time, t2, t3, t4, t5.x, t5.y, t5.z);
},
...
$$.Answer_explain_anon0 = {"": ["answerText_3", "output_2"],
 "super": "Closure",
 call$1: function(event$) {
  var t1 = this.answerText_3;
  this.output_2.set$innerHTML(t1);
  return t1;
}
};
...
$$.Answer_explain_anon2 = {"": ["answerText_7", "output_6"],
 "super": "Closure",
 call$1: function(event$) {
  var t1 = this.answerText_7;
  this.output_6.set$innerHTML(t1);
  return t1;
}
};

$$.Answer_toggleListener_anon = {"": ["modal_2", "button_1", "this_0"],
 "super": "Closure",
 call$1: function(event$) {
  return this.this_0.showModal$2(this.button_1, this.modal_2);
}
};

$$.Answer_toggleListener_anon0 = {"": ["modal_5", "button_4", "this_3"],
 "super": "Closure",
 call$1: function(event$) {
  return this.this_3.hideModal$2(this.button_4, this.modal_5);
}
};

$$.Answer_toggleListener_anon1 = {"": ["modal_8", "button_7", "this_6"],
 "super": "Closure",
 call$1: function(event$) {
  return this.this_6.toggleListener$3(3, this.button_7, this.modal_8);
}
};
...
$$.SingleSelect__makeButton_anon = {"": ["number_1", "this_0"],
 "super": "Closure",
 call$1: function(event$) {
...
$$.XmlCollection__queryAllNamesInternal_anon0 = {"": ["tagName_1", "list_0"],
 "super": "Closure",
 call$1: function(el) {
  el._queryAllNamesInternal$2(this.tagName_1, this.list_0);
}
};
...
$$.XmlCollection__queryAttributeInternal_checkAttribs = {"": ["n_3", "aMap_2"],
 "super": "Closure",
 call$0: function() {
  var t1, t2;
  t1 = {};
  t1.succeed_10 = true;
  t2 = this.aMap_2;
  $.getInterceptor(t2).forEach$1(t2, new $.XmlCollection__queryAttributeInternal_checkAttribs_anon(this.n_3, t1));
  return t1.succeed_10;
}
};

$$.XmlCollection__queryAttributeInternal_checkAttribs_anon = {"": ["n_4", "box_0"],
 "super": "Closure",
 call$2: function(k, v) {
  var t1 = this.box_0;
...
$$.XmlCollection__queryAttributeInternal_anon = {"": ["list_6", "aMap_5"],
 "super": "Closure",
 call$1: function(el) {
  var t1 = this.list_6;
  if ($.getInterceptor(t1).get$isEmpty(t1) !== true)
...
$$.XmlElement__queryAttributeInternal_checkAttribs = {"": ["aMap_3", "this_2"],
 "super": "Closure",
 call$0: function() {
  var t1, t2;
  t1 = {};
  t1.succeed_1 = true;
  t2 = this.aMap_3;
  $.getInterceptor(t2).forEach$1(t2, new $.XmlElement__queryAttributeInternal_checkAttribs_anon(t1, this.this_2));
  return t1.succeed_1;
}
};

$$.XmlElement__queryAttributeInternal_checkAttribs_anon = {"": ["box_0", "this_4"],
 "super": "Closure",
 call$2: function(k, v) {
  var t1 = this.box_0;
...
$$.XmlCollection__queryNodeTypeInternal_anon = {"": ["nodeType_1", "list_0"],
 "super": "Closure",
 call$1: function(el) {
  var t1 = this.list_0;
  if ($.getInterceptor(t1).get$isEmpty(t1) !== true)
  ...
  if (typeof el === 'object' && el !== null && !!el.is$XmlElement)
    el._queryNodeTypeInternal$2(this.nodeType_1, t1);
  else if ($.eqB(el.get$type(), this.nodeType_1)) {
    t1._add$1(el);
    return;
  }
}
...
$$.XmlElement__queryNameInternal_anon = {"": ["tagName_1", "list_0"],
 "super": "Closure",
 call$1: function(el) {
  var t1 = this.list_0;
  if ($.getInterceptor(t1).get$isEmpty(t1) !== true)
    return;
  el._queryNameInternal$2(this.tagName_1, t1);
}
};
...
$$.XmlTokenizer__next_getNextToken = {"": ["this_1"],
 ...
 call$0: function() {
  var t1, t2;
  t1 = this.this_1;
  t2 = t1.get$_liblib2$_buffer();
  return $.getInterceptor(t2).get$isEmpty(t2) === true ? null : t1.get$_liblib2$_buffer().removeFirst$0();
}
};
...
$$.XmlTokenizer__next_peekUntil = {"": ["this_2"],
 ...
 call$1$bailout2: function(state0, chars, t1, z) {
  var t2, t3;
  for (; t2 = $.getInterceptor(chars), t3 = t1.get$_xml(), $.eqB(t2.indexOf$1(chars, $.getInterceptor(t3).charCodeAt$1(t3, z)), -1);) {
    z = $.add(z, 1);
    if ($.geB(z, t1.get$_liblib2$_length()))
...
$$.XmlTokenizer__next_matchWord = {"": ["this_3"],
 ...
 call$1: function(word) {
  ...
  z = t1.get$_i();
  if (typeof z !== 'number')
    return this.call$1$bailout1(1, word, t1, z);
 ...
 call$1$bailout1: function(state0, word, t1, z) {
  var ii, t2;
  for (ii = 0; $.ltB(ii, $.getInterceptor(word).get$length(word)); ++ii) {
    t2 = t1.get$_xml();
    if (!$.eqB($.getInterceptor(t2).charCodeAt$1(t2, z), $.getInterceptor(word).charCodeAt$1(word, ii)))
...
$$.XmlParser__parseAttribute_quotesRequired = {"": ["t_6", "this_5", "setAttribute_4", "box_0"],
 "super": "Closure",
 call$0: function() {
  var t1, t2, s, qkind;
  t1 = this.this_5;
...
$$.XmlParser__parseNamespace_quotesRequired = {"": ["name_6", "t_5", "this_4", "setNamespace_3", "box_0"],
 "super": "Closure",
 call$0: function() {
  var t1, t2, s, qkind;
  t1 = this.this_4;
  ...
  this.setNamespace_3.call$2(this.name_6, $.getInterceptor(s).toString$0(s));
},
...
$$._convertDartToNative_PrepareForStructuredClone_findSlot = {"": ["copies_3", "values_2"],
 ...
 call$1$bailout4: function(state0, env0, env1, env2) {
  switch (state0) {
    case 1:
      t1 = env1;
      value = env0;
...
$$._convertDartToNative_PrepareForStructuredClone_walk = {"": ["writeSlot_8", "readSlot_7", "findSlot_6"],
 ...
 call$1: function(e) {
  ...
  if (typeof e === 'object' && e !== null && (e.constructor === Array || e.is$List())) {
      ...
      for (i = 0; i < length$; ++i) {
        ...
        if (!(elementCopy == null ? element == null : elementCopy === element)) {
          ...
          if (typeof copy0 !== 'object' || copy0 === null || (copy0.constructor !== Array || !!copy0.immutable$list) && !copy0.is$JavaScriptIndexingBehavior())
            return this.call$1$bailout3(3, e, t3, elementCopy, length$, copy0, slot, t2, i, copy);
    ...
    if (typeof copy !== 'object' || copy === null || (copy.constructor !== Array || !!copy.immutable$list) && !copy.is$JavaScriptIndexingBehavior())
      return this.call$1$bailout3(4, e, length$, copy, i);
    for (; i < length$; ++i) {
      if (i >= e.length)
        throw $.ioore(i);
      t1 = this.call$1(e[i]);
 ...
 call$1$bailout3: function(state0, env0, env1, env2, env3, env4, env5, env6, env7, env8) {
  switch (state0) {
    case 1:
      e = env0;
      break;
...
$.addTestSlide = function() {
  var slideElement = $.get$test().get$currentSection().explain$0();
  $.get$presentation().addElementSlide$8(slideElement, 1, 200, 200, 0, 0, 0, 0);
};

$.addBackground = function() {
  var element, slide;
  element = $.ImageElement_ImageElement(null, null, null);
  element.set$src("images/pixel_map_generic_wloc.png");
  slide = $.Slide$(element, 100, 0, 0, -50, 0, 0, 0);
  $.get$presentation().addBackgroundSlide$1(slide);
};
...
$.onSuccess = function(request) {
  ...
  $.get$test().next$0();
  $.get$test().nextSection$0();
  $.addBackground();
  $.addTestSlide();
  $.get$presentation().start$0();
};
...
Isolate.$lazy($, 'presentation', 'presentation', 'get$presentation', function() {
...
$.$defineNativeClass('HTMLFieldSetElement', {"": ["disabled<", "name>", "type>"],
 is$Element: function() { return true; }
});
...
$.$defineNativeClass('DOMWindow', {"": ["name>", "navigator>", "status>"],
 ...
 get$_liblib$_location: function() {
  return this.location;
},
 set$_liblib$_location: function(value) {
  this.location = value;
},
 get$on: function() {
