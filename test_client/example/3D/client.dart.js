...
$$.ConstantMap = {"": ["length>", "_jsObject", "_liblib$_keys"],
 "super": "Object",
...
$$._AllMatchesIterator = {"": ["_re", "_str>", "_liblib$_next=", "_done"],
 "super": "Object",
 _liblib$_next$0: function() { return this._liblib$_next.call$0(); },
 next$0: function() {
  if (this.get$hasNext() !== true)
    throw $.$$throw($.StateError$("No more elements"));
...
$$._ElementCssClassSet = {"": ["_liblib0$_element>"],
 "super": "CssClassSet",
 readClasses$0: function() {
  var s, classname, t1, t2, trimmed;
  s = $.Set_Set();
  classname = this._liblib0$_element.get$$$dom_className();
 ...
 writeClasses$1: function(s) {
  ...
  this._liblib0$_element.set$$$dom_className(t1);
}
};
...
$$.Answer = {"": ["points>", "text>", "explanation>", "_showEvent", "_hideEvent", "_skipEvent"],
 ...
 toggleListener$3: function(step, button, modal) {
  ...
  if (this._showEvent == null)
    this._showEvent = new $.Answer_toggleListener_anon(this, modal, button);
  if (this._hideEvent == null)
    this._hideEvent = new $.Answer_toggleListener_anon0(this, modal, button);
  if (this._skipEvent == null)
    this._skipEvent = new $.Answer_toggleListener_anon1(this, modal, button);
  if (step === 1) {
...
$$.XmlParser = {"": ["_xml>", "_scopes>", "_withQuirks", "_root"],
 ...
 _parseNamespace$1: function(t) {
  ...
  t1.next_1 = t.next$0();
  t4 = new $.XmlParser__parseNamespace_quotesRequired(t3, name$, this, t, t1);
 ...
 _parseAttribute$2: function(t, attributeName) {
  ...
  t1.next_2 = t.next$0();
  t3 = new $.XmlParser__parseAttribute_quotesRequired(t, t1, t2, this);
  if (this._withQuirks === true) {
    t4 = t1.next_2;
    t5 = t4.get$kind();
    if (typeof t5 !== 'number')
...
$$.XmlCollection__queryAttributeInternal_checkAttribs = {"": ["aMap_3", "n_2"],
 ...
 call$0: function() {
  ...
  t1.succeed_10 = true;
  t2 = this.aMap_3;
  $.getInterceptor(t2).forEach$1(t2, new $.XmlCollection__queryAttributeInternal_checkAttribs_anon(this.n_2, t1));
...
$$.XmlElement__queryAttributeInternal_checkAttribs = {"": ["aMap_3", "this_2"],
 ...
 call$0: function() {
  ...
  t1.succeed_1 = true;
  t2 = this.aMap_3;
  $.getInterceptor(t2).forEach$1(t2, new $.XmlElement__queryAttributeInternal_checkAttribs_anon(this.this_2, t1));
  return t1.succeed_1;
}
};
...
$$.XmlParser__parseAttribute_quotesRequired = {"": ["t_6", "box_0", "setAttribute_5", "this_4"],
 "super": "Closure",
 call$0: function() {
  var t1, t2, s, qkind;
  t1 = this.this_4;
...
$$.XmlParser__parseNamespace_quotesRequired = {"": ["setNamespace_6", "name_5", "this_4", "t_3", "box_0"],
 "super": "Closure",
 call$0: function() {
  var t1, t2, s, qkind;
  t1 = this.this_4;
  ...
  this.setNamespace_6.call$2(this.name_5, $.getInterceptor(s).toString$0(s));
},
...
$$.Answer_toggleListener_anon = {"": ["this_2", "modal_1", "button_0"],
 "super": "Closure",
 call$1: function(event$) {
  return this.this_2.showModal$2(this.button_0, this.modal_1);
}
};

$$.Answer_toggleListener_anon0 = {"": ["this_5", "modal_4", "button_3"],
 "super": "Closure",
 call$1: function(event$) {
  return this.this_5.hideModal$2(this.button_3, this.modal_4);
}
};

$$.Answer_toggleListener_anon1 = {"": ["this_8", "modal_7", "button_6"],
 "super": "Closure",
 call$1: function(event$) {
  return this.this_8.toggleListener$3(3, this.button_6, this.modal_7);
}
};
...
$.getStamp = function(number, placed) {
  var stampContainer, stamp, t1;
  stampContainer = $.DivElement_DivElement();
  $.ParagraphElement_ParagraphElement();
...
$.addSlideToMap = function(slideContents) {
  var y;
  $.mul($.currentSlidePosition, 2000);
  y = $.sin($.add($.div($.currentSlidePosition, 2), -3)) * 10000;
  return $.get$slideshow().addElementSlide$8(slideContents, 1, $.mul($.currentSlidePosition, 2000), y, 0, 0, 0, 0);
};
...
$.nextQuestion = function() {
  var slideElement, t1, sectionFluency;
  slideElement = $.get$test().next$0();
  $.hideButtons();
  t1 = slideElement.get$id();
  if ($.getInterceptor(t1).startsWith$1(t1, "summary") === true) {
    $.enableSummaryButtons();
    t1 = $.div($.get$test().get$currentSection().getUserAnswerPoints$0(), $.get$test().get$currentSection().getMaxPoints$0());
    if (typeof t1 !== 'number')
      throw $.iae(t1);
    sectionFluency = 100 * t1;
...
$.$defineNativeClass('DOMWindow', {"": ["name>", "navigator>", "status>"],
 ...
 get$_liblib0$_location: function() {
  return this.location;
},
 set$_liblib0$_location: function(value) {
  this.location = value;
},
 get$on: function() {
