...
$$.ConstantMap = {"":"Object;length?,_jsObject,_lib0_keys?",
 containsValue$1: function(needle) {
  ...
  return $.getInterceptor$JSArray(t1).some$1(t1, new $.ConstantMap_containsValue_anon(needle));
},
...
$$._AllMatchesIterator = {"":"Object;_re,_str?,_lib0_next=,_done",
 _lib0_next$0: function() { return this._lib0_next.call$0(); },
 next$0: function() {
  if (this.get$hasNext() !== true)
    throw $.$$throw($.StateError$("No more elements"));
        ...
        while (true)
          switch (state0) {
            case 0:
              ...
              key = t1[i];
            case 1:
              if (state0 === 1 || state0 === 0 && !(key == null) && !(key === $.CTC4))
                switch (state0) {
                  case 0:
                    t1 = this._values;
                    if (i >= t1.length)
...
$$._LinkedHashMapImpl = {"":"Object;_lib_list,_map",
 operator$indexSet$2: function(key, value) {
  if (this._map.containsKey$1(key) === true)
    $.index(this._map, key).get$element().set$value(value);
  else {
    this._lib_list.addLast$1($._KeyValuePair$(key, value));
 ...
 get$keys: function() {
  ...
  list = $.List_List(this.get$length());
  t1.index_10 = 0;
  this._lib_list.forEach$1(new $._LinkedHashMapImpl_keys_anon(t1, list));
  return list;
},
 get$values: function() {
  var t1, list;
  ...
  list = $.List_List(this.get$length());
  t1.index_1 = 0;
  this._lib_list.forEach$1(new $._LinkedHashMapImpl_values_anon(t1, list));
  return list;
},
 forEach$1: function(f) {
  this._lib_list.forEach$1(new $._LinkedHashMapImpl_forEach_anon(f));
},
 containsKey$1: function(key) {
  return this._map.containsKey$1(key);
},
 containsValue$1: function(value) {
  return this._lib_list.some$1(new $._LinkedHashMapImpl_containsValue_anon(value));
},
 get$length: function() {
  var t1 = this._map;
 ...
 _LinkedHashMapImpl$0: function() {
  ...
  this._lib_list = $.DoubleLinkedQueue$();
},
 is$Map: function() { return true; }
};
...
$$.DoubleLinkedQueueEntry = {"":"Object;_previous!,_next=,_lib_element?",
...
$$._DoubleLinkedQueueEntrySentinel = {"":"DoubleLinkedQueueEntry;_previous,_next,_lib_element",
 remove$0: function() {
...
$$.DoubleLinkedQueue = {"":"Object;_sentinel",
 ...
 filter$1: function(f) {
  ...
  for (t1 = $.getInterceptor$JSArray(other); !(entry === this._sentinel); entry = nextEntry) {
    nextEntry = entry.get$_next();
    if (f.call$1(entry.get$_lib_element()) === true)
      t1.addLast$1(other, entry.get$_lib_element());
  }
  return other;
},
 iterator$0: function() {
...
$$.EventListenerList = {"":"Object;_ptr,_lib3_type",
...
$$._AttributeMap = {"":"Object;",
 containsValue$1: function(value) {
  var t1;
  for (t1 = this.get$values(), t1 = $.getInterceptor$JSArray(t1).iterator$0(t1); t1.get$hasNext() === true;)
    if (value === t1.next$0())
      return true;
  return false;
},
...
$$.Test = {"":"Object;sections?,currentSection?",
 nextSection$0: function() {
  var t1, num;
  t1 = this.currentSection;
  num = t1 == null ? 0 : $.add($.CTC1.indexOf$2(this.sections, t1, 0), 1);
  t1 = this.sections;
...
$$.Question = {"":"Object;text=,explanation?",
 explain$0: function() {
  var output, t1;
  output = $.DivElement_DivElement();
  output.appendHtml$1("<br/><h4>" + $.S(this.text) + "</h4>");
  t1 = output.get$classes();
  $.getInterceptor$JSArray(t1).add$1(t1, "explanation");
  t1 = this.explanation;
  if (!(t1 == null))
    output.appendHtml$1("Explanation: " + $.S(t1) + "<br/>");
  return output;
},
...
$$.Answer = {"":"Object;points?,text=,explanation?,_showEvent,_hideEvent,_skipEvent",
 displayForExplanation$2: function(selectedByUser, maxPoints) {
  ...
  if (typeof maxPoints !== 'number')
    throw $.iae(maxPoints);
  pointsColorNum = $.CTC2.toInt$0($.tdiv(t1, maxPoints));
  pointsColorHex = $.getInterceptor$JSNumber(pointsColorNum).toRadixString$1(pointsColorNum, 16);
 ...
 explain$3: function(selectedByUser, maxPoints, displayExplanationMode) {
  ...
  if (!(t1 === "") && displayExplanationMode === 1) {
    ...
    $.getInterceptor$JSArray(t1).add$1(t1, new $.Answer_explain_anon(output, this));
    t1 = output.get$on().get$mouseOut();
    $.getInterceptor$JSArray(t1).add$1(t1, new $.Answer_explain_anon0(output, answerText));
  }
  t1 = this.explanation;
  if (typeof t1 !== 'string')
  ...
  if (!(t1 === "") && displayExplanationMode === 2) {
    t1 = output.get$on().get$mouseOver();
    $.getInterceptor$JSArray(t1).add$1(t1, new $.Answer_explain_anon1(output, this));
    t1 = output.get$on().get$mouseOut();
    $.getInterceptor$JSArray(t1).add$1(t1, new $.Answer_explain_anon2(output, answerText));
  }
  t1 = this.explanation;
  if (typeof t1 !== 'string')
  ...
  if (!(t1 === "") && displayExplanationMode === 3) {
    ...
    $.getInterceptor$JSArray(t1).add$1(t1, "modal");
 ...
 toggleListener$3: function(step, button, modal) {
  ...
  if (this._showEvent == null)
    this._showEvent = new $.Answer_toggleListener_anon(this, button, modal);
  if (this._hideEvent == null)
    this._hideEvent = new $.Answer_toggleListener_anon0(this, button, modal);
  if (this._skipEvent == null)
    this._skipEvent = new $.Answer_toggleListener_anon1(this, button, modal);
  if (step === 1) {
    t1 = button.get$on().get$click();
    $.getInterceptor$JSArray(t1).add$1(t1, this._showEvent);
    ...
    $.getInterceptor$JSArray(t1).add$1(t1, this._skipEvent);
  } else {
    $.document().get$on().get$click().remove$1(this._skipEvent);
    t1 = $.document().get$on().get$click();
    $.getInterceptor$JSArray(t1).add$1(t1, this._hideEvent);
  }
},
...
$$.MultipleChoice = {"":"Question;",
 displayAnswers$0: function() {
  ...
  for (t1 = $.CTC1.iterator$0(this.answers), number = 0; t1.get$hasNext() === true;) {
    t2 = t1.next$0();
    button = this._makeButton$2(t2, number);
    ++number;
    output.insertAdjacentElement$2("beforeEnd", button);
    output.appendHtml$1($.S(t2.get$text()));
    output.appendHtml$1("<br/>");
  }
  return output;
},
 display$0: function() {
...
$$.MultipleSelect = {"":"MultipleChoice;selectedAnswers,answers,text,explanation",
 toggleAnswer$1: function(answerIndex) {
  ...
  selectedIndex = $.CTC1.indexOf$2(t1, answer, 0);
  if ($.eqB(selectedIndex, -1))
    t1.push(answer);
  else
    $.CTC1.removeAt$1(t1, selectedIndex);
  $.query("#nextButton").get$style().set$visibility("visible");
  this.enableNextButton$0();
},
 _makeButton$2: function(answer, number) {
  var element, t1;
  element = $.Element_Element$html("<input type=\"checkbox\" name=\"" + $.S($.CTC3.toString$0(number)) + "\">");
  t1 = element.get$on().get$click();
  $.getInterceptor$JSArray(t1).add$1(t1, new $.MultipleSelect__makeButton_anon(number, this));
  return element;
},
 getMaximumPoints$0: function() {
  var t1, total, t2, t3;
  for (t1 = $.CTC1.iterator$0(this.answers), total = 0; t1.get$hasNext() === true;) {
    t2 = t1.next$0();
    t3 = t2.get$points();
    if (typeof t3 !== 'number')
 ...
 getMaximumPoints$0$bailout: function(state0, env0, env1, env2, env3) {
  ...
  switch (state0) {
    case 0:
      t1 = $.CTC1.iterator$0(this.answers);
      total = 0;
    default:
      var t1, total, t2, t3;
      L0:
 ...
 getUserAnswerPoints$0: function() {
  var t1, total, t2;
  for (t1 = $.CTC1.iterator$0(this.selectedAnswers), total = 0; t1.get$hasNext() === true;) {
 ...
 getUserAnswerPoints$0$bailout0: function(state0, env0, env1, env2) {
  ...
  switch (state0) {
    case 0:
      t1 = $.CTC1.iterator$0(this.selectedAnswers);
      total = 0;
    case 1:
      var t1, total, t2;
      L0:
 ...
 explain$0: function() {
  ...
  for (t1 = $.CTC1.iterator$0(this.answers), t2 = this.selectedAnswers; t1.get$hasNext() === true;) {
    t3 = t1.next$0();
    explainAnswers.insertAdjacentElement$2("beforeEnd", t3.explain$3(!$.eqB($.CTC1.indexOf$1(t2, t3), -1), 1, 3));
  }
...
$$.SingleSelect = {"":"MultipleChoice;selected,answers,text,explanation",
 getMaximumPoints$0: function() {
  var t1, highest, t2, t3;
  for (t1 = $.CTC1.iterator$0(this.answers), highest = 0; t1.get$hasNext() === true;) {
    t2 = t1.next$0();
    t3 = t2.get$points();
    if (typeof t3 !== 'number')
 ...
 _makeButton$2: function(answer, number) {
  ...
  t1 = element.get$on().get$click();
  $.getInterceptor$JSArray(t1).add$1(t1, new $.SingleSelect__makeButton_anon(number, this));
  return element;
},
 explain$0: function() {
  ...
  output = $.Question.prototype.explain$0.call(this);
  explainAnswers = $.UListElement_UListElement();
  for (t1 = $.CTC1.iterator$0(this.answers); t1.get$hasNext() === true;) {
    t2 = t1.next$0();
...
$$.TestSection = {"":"Object;questions,allQnA,star?,name?,description,reference,currentQuestion,atSummary?,atExplanation,finished,done?,explainCorrectQuestions,finalPercentage?,finalTotalAns?,finalFluentAns?",
 getQnA$0: function() {
  var t1, t2, sections, sectionName, t3, sectionDescription, t4, referenceURL, questionList, text, explanation, answerList, answers, t5, points, answerTxt, explainTxt, ss_question, ms_question;
  t1 = this.allQnA;
  t2 = this.star;
  sections = t1.query$1($.makeLiteralMap(["level", $.getInterceptor(t2).toString$0(t2)]));
  for (t1 = $.getInterceptor$JSArray(sections).iterator$0(sections); t1.get$hasNext() === true;) {
    t2 = t1.next$0();
    sectionName = t2.query$1("name");
    t3 = $.getInterceptor$JSArray(sectionName).get$last(sectionName);
    this.name = $.getInterceptor(t3).toString$0(t3);
    sectionDescription = t2.query$1("description");
    t4 = $.getInterceptor$JSArray(sectionDescription).get$last(sectionDescription);
    this.description = $.getInterceptor(t4).toString$0(t4);
    referenceURL = t2.query$1("reference");
    this.reference = $.getInterceptor$JSArray(referenceURL).get$last(referenceURL).get$text();
    questionList = t2.queryAll$1("question");
    for (t2 = $.getInterceptor$JSArray(questionList).iterator$0(questionList); t2.get$hasNext() === true;) {
      t3 = t2.next$0();
      text = t3.query$1("text");
      explanation = t3.query$1("explanation");
      answerList = t3.queryAll$1("answer");
      answers = $.List_List(null);
      for (t4 = $.getInterceptor$JSArray(answerList).iterator$0(answerList); t4.get$hasNext() === true;) {
        t5 = t4.next$0();
        points = t5.query$1("points");
        answerTxt = t5.query$1("text");
        explainTxt = t5.query$1("explanation");
        answers.push($.Answer$($.parseInt($.index(points, 0).get$text()), $.index(answerTxt, 0).get$text(), $.index(explainTxt, 0).get$text()));
      }
      if (t3.get$attributes().containsValue$1("SingleSelect") === true || t3.get$attributes().containsValue$1("MultipleChoice") === true) {
        ...
        $.CTC1.addAll$1(ss_question.answers, answers);
        t3 = this.questions;
        $.getInterceptor$JSArray(t3).add$1(t3, ss_question);
        ...
        $.CTC1.addAll$1(ms_question.answers, answers);
        t3 = this.questions;
        $.getInterceptor$JSArray(t3).add$1(t3, ms_question);
      }
    }
  }
},
 nextQuestion$0: function() {
  ...
  if (t1 == null) {
    ...
    t2 = this.questions;
    num = $.add($.getInterceptor$JSStringJSArray(t2).indexOf$2(t2, t1, 0), 1);
  }
  t1 = this.questions;
  if ($.gtB($.getInterceptor$JSStringJSArray(t1).get$length(t1), num))
 ...
 displayCurrentQuestion$0: function() {
  ...
  t1 = this.questions;
  questionNumber = $.add($.getInterceptor$JSStringJSArray(t1).indexOf$2(t1, this.currentQuestion, 0), 1);
  t2 = this.questions;
  sectionLength = $.getInterceptor$JSStringJSArray(t2).get$length(t2);
  output.appendHtml$1("<h4>" + (sectionHeader + "<br/> Question " + $.S(questionNumber) + " of " + $.S(sectionLength)) + "</h4>");
 ...
 explain$0: function() {
  var output, t1;
  output = $.DivElement_DivElement();
  for (t1 = this.explanations$0(), t1 = $.getInterceptor$JSArray(t1).iterator$0(t1); t1.get$hasNext() === true;)
 ...
 explanations$0: function() {
  ...
  for (t1 = this.questions, t1 = $.getInterceptor$JSArray(t1).iterator$0(t1), index = 0; t1.get$hasNext() === true;) {
    t2 = t1.next$0();
    ++index;
    questionExplanation = t2.explain$0();
    questionExplanation.set$id("Section" + $.S(this.star) + "Explanation{" + $.S(index) + "}");
    output.push(questionExplanation);
  }
  return output;
},
 getMaxPoints$0: function() {
  var t1, total, t2;
  for (t1 = this.questions, t1 = $.getInterceptor$JSArray(t1).iterator$0(t1), total = 0; t1.get$hasNext() === true;) {
 ...
 summary$0: function() {
  var output, t1, passport, leftSide, content$, percentageScore, best, agile, t2, t3, t4, t5, t6, t7, t8;
  $.print("Summary section.");
  output = $.DivElement_DivElement();
  output.set$id("summary" + $.S(this.star));
  t1 = output.get$classes();
  $.getInterceptor$JSArray(t1).add$1(t1, "summary");
  passport = $.ImageElement_ImageElement(null, null, null);
  t1 = passport.get$classes();
  $.getInterceptor$JSArray(t1).add$1(t1, "passportImage");
  passport.set$src("images/passport_m.png");
  passport.get$style().set$zIndex("-10");
  output.insertAdjacentElement$2("beforeEnd", passport);
  leftSide = $.DivElement_DivElement();
  leftSide.set$id("stampsDiv" + $.S(this.star));
  t1 = leftSide.get$classes();
  $.getInterceptor$JSArray(t1).add$1(t1, "stampsDiv");
  output.insertAdjacentElement$2("beforeEnd", leftSide);
  content$ = $.ParagraphElement_ParagraphElement();
  t1 = content$.get$classes();
  $.getInterceptor$JSArray(t1).add$1(t1, "detail");
  content$.appendHtml$1("<h4>Destination " + $.S(this.star) + ": " + $.S(this.name) + "<br/>Summary</h4>");
  t1 = $.tdiv($.mul(this.getUserAnswerPoints$0(), 100), this.getMaxPoints$0());
  percentageScore = $.getInterceptor$JSNumber(t1).toInt$0(t1);
  for (t1 = this.questions, t1 = $.getInterceptor$JSArray(t1).iterator$0(t1), best = 0, agile = 0; t1.get$hasNext() === true;) {
    t2 = t1.next$0();
  ...
  content$.appendHtml$1("<h4>Estimated Fluency: " + $.S(percentageScore) + "%</h4>");
  t1 = "<li>Total Agile Answers: " + $.S(agile) + "/";
  t2 = this.questions;
  content$.appendHtml$1(t1 + $.S($.getInterceptor$JSStringJSArray(t2).get$length(t2)) + "</li>");
  t3 = "<li>Most Fluent Answers: " + $.S(best) + "/";
  t4 = this.questions;
  content$.appendHtml$1(t3 + $.S($.getInterceptor$JSStringJSArray(t4).get$length(t4)) + "</li></ul>");
  this.finalPercentage = $.S(percentageScore);
  t5 = $.S(agile) + "/";
  t6 = this.questions;
  this.finalTotalAns = t5 + $.S($.getInterceptor$JSStringJSArray(t6).get$length(t6));
  t7 = $.S(best) + "/";
  t8 = this.questions;
  this.finalFluentAns = t7 + $.S($.getInterceptor$JSStringJSArray(t8).get$length(t8));
  content$.appendHtml$1("<p class=\"italicIndent\">" + $.S(this.description) + "</p>");
  content$.appendHtml$1("<p class=\"smallerLeft\">Learn more about " + $.S(this.name) + " <a href='" + $.S(this.reference) + "' target='_blank'>here</a></p>");
 ...
 TestSection$2: function(level, xml) {
  ...
  this.getQnA$0();
  t1 = this.questions;
  $.print("Number of Questions : " + $.S($.getInterceptor$JSStringJSArray(t1).get$length(t1)));
}
};
...
$$.XmlElement = {"":"XmlNode;name?,_children?,_attributes,_namespaces,type,parent",
 get$text: function() {
  var tNodes, t1, s;
  tNodes = this._children.filter$1(new $.XmlElement_text_anon());
  t1 = $.getInterceptor$JSStringJSArray(tNodes);
  if (t1.get$isEmpty(tNodes) === true)
    return "";
  s = $.StringBuffer_StringBuffer("");
  t1.forEach$1(tNodes, new $.XmlElement_text_anon0(s));
 ...
 get$namespacesInScope: function() {
  ...
  l = [];
  t1 = this._namespaces;
  $.getInterceptor$JSArray(t1).forEach$1(t1, new $.XmlElement_namespacesInScope_anon(l));
  t1 = this.parent;
  if (!(t1 == null) && typeof t1 === 'object' && t1 !== null && !!t1.is$XmlElement)
    $.CTC1.addAll$1(l, this.parent.get$namespacesInScope());
  return l;
},
 isNamespaceInScope$1: function(namespace) {
  var t1 = this.get$namespacesInScope();
  return $.getInterceptor$JSArray(t1).some$1(t1, new $.XmlElement_isNamespaceInScope_anon(namespace));
},
 ...
 addChildren$1: function(elements) {
  var t1 = $.getInterceptor$JSStringJSArray(elements);
  if (t1.get$isEmpty(elements) !== true)
    t1.forEach$1(elements, new $.XmlElement_addChildren_anon(this));
},
 ...
 _queryAttributeInternal$2: function(aMap, list) {
  var t1;
  if (new $.XmlElement__queryAttributeInternal_checkAttribs(aMap, this).call$0() === true) {
    list._add$1(this);
    return;
  } else if (this.get$hasChildren() === true) {
    t1 = this.get$children().allElements$0();
    $.getInterceptor$JSArray(t1).forEach$1(t1, new $.XmlElement__queryAttributeInternal_anon(list, aMap));
  }
},
 _queryNodeTypeInternal$2: function(nodeType, list) {
  ...
  if ($.eqB(this.type, nodeType)) {
    ...
    $.getInterceptor$JSArray(t1).forEach$1(t1, new $.XmlElement__queryNodeTypeInternal_anon(list, nodeType));
  }
},
 _queryNameInternal$2: function(tagName, list) {
  ...
  if ($.eqB(this.name, tagName)) {
    ...
    t1 = this.get$children().allElements$0();
    $.getInterceptor$JSArray(t1).forEach$1(t1, new $.XmlElement__queryNameInternal_anon(list, tagName));
  }
},
 ...
 _queryAllNamesInternal$2: function(tagName, list) {
  ...
  if (this.get$hasChildren() === true) {
    t1 = this.get$children();
    t1 = $.getInterceptor$JSArray(t1).filter$1(t1, new $.XmlElement__queryAllNamesInternal_anon());
    $.getInterceptor$JSArray(t1).forEach$1(t1, new $.XmlElement__queryAllNamesInternal_anon0(list, tagName));
  }
},
...
$$.XmlParser = {"":"Object;_xml?,_scopes?,_withQuirks,_root",
 _parseElement$1: function(t) {
  var tok, t1, t2;
  tok = t.next$0();
  for (t1 = this._scopes, t2 = $.getInterceptor$JSStringJSArray(t1); !(tok == null);) {
    switch (tok.get$kind()) {
      case 12:
      ...
      case 4:
        if (t2.get$isEmpty(t1) === true)
          ...
          this._parseTextNode$2(t, tok.get$_lib2_str());
          this._parseTag$1(t);
        }
        break;
    }
 ...
 _parsePI$1: function(t) {
  ...
  data = next.get$_lib2_str();
  this._assertKind$2(t.next$0(), 17);
  $.getInterceptor$JSArray(t1).get$first(t1).addChild$1($.XmlProcessingInstruction$(data));
},
 _parseCDATA$1: function(t) {
  ...
  $.getInterceptor$JSArray(t1).get$first(t1).addChild$1($.XmlCDATA$(data));
},
 ...
 _parseTag$1: function(t) {
  ...
  if ($.eqB(next.get$kind(), 7)) {
    ...
    t1 = this._scopes;
    t2 = $.getInterceptor$JSArray(t1);
    if (!$.eqB(t2.get$first(t1).get$name(), name$))
      throw $.$$throw($.XmlException$withDebug("Expected closing tag \"" + $.S(t2.get$first(t1).get$name()) + "\"" + " but found \"" + $.S(name$) + "\" instead.", this._xml, next.get$_location()));
  ...
  newElement = $.XmlElement$(name$, $.CTC16);
  t1 = this._root == null;
  t2 = this._scopes;
  if (t1) {
    ...
    $.getInterceptor$JSArray(t2).get$first(t2).addChild$1(newElement);
    t2.addFirst$1(newElement);
  }
  t1 = this._scopes;
  t2 = $.getInterceptor$JSArray(t1);
  t3 = t2.get$first(t1).get$name();
  if ($.getInterceptor$JSStringJSArray(t3).contains$1(t3, ":") === true) {
    t3 = t2.get$first(t1).get$name();
    ns = $.index($.getInterceptor$JSString(t3).split$1(t3, ":"), 0);
    if (t2.get$first(t1).isNamespaceInScope$1(ns) !== true)
  ...
  for (; !(next == null);) {
    switch (next.get$kind()) {
      case 18:
        ...
        break;
      case 4:
        this._parseAttribute$2(t, next.get$_lib2_str());
        break;
      case 2:
 ...
 _parseTextNode$2: function(t, text) {
  ...
  t3 = t1.s_1;
  $.getInterceptor$JSArray(t3).add$1(t3, text);
  next = t.next$0();
  for (; !$.eqB(next.get$kind(), 1);) {
    switch (next.get$kind()) {
      ...
      default:
        t3 = t1.s_1;
        $.getInterceptor$JSArray(t3).add$1(t3, next.toStringLiteral$0());
        break;
    }
    next = t.next$0();
    if (next == null)
 ...
 _parseNamespace$1: function(t) {
  ...
  t1 = {};
  t2 = this._scopes;
  t3 = new $.XmlParser__parseNamespace_setNamespace($.getInterceptor$JSArray(t2).get$first(t2));
  t1.next_1 = t.next$0();
  this._assertKind$3(t1.next_1, 4, "Must declare namespace name.");
  name$ = t1.next_1.get$_lib2_str();
  t1.next_1 = t.next$0();
  this._assertKind$3(t1.next_1, 8, "Must have an = after a namespace name.");
  t1.next_1 = t.next$0();
  t4 = new $.XmlParser__parseNamespace_quotesRequired(name$, t1, t3, t, this);
  if (this._withQuirks === true) {
    ...
    if (t5 === 4)
      t3.call$2(name$, t2.get$_lib2_str());
    else if (t5 === 9)
      t4.call$0();
  } else
    t4.call$0();
        ...
        switch (state0) {
          ...
          case 2:
            if (state0 === 0 && $.eqB(t2, 4))
              t3.call$2(name$, t1.next_1.get$_lib2_str());
            else
              switch (state0) {
                case 0:
                  t2 = t1.next_1.get$kind();
 ...
 _parseAttribute$2: function(t, attributeName) {
  ...
  t2 = this._scopes;
  el = $.getInterceptor$JSArray(t2).get$first(t2);
  ...
  if (t3 === 6) {
    ...
    t1.attributeName_1 = $.S(t1.attributeName_1) + ":" + $.S(t1.next_2.get$_lib2_str());
    t1.next_2 = t.next$0();
  }
  this._assertKind$3(t1.next_2, 8, "Must have an = after an attribute name.");
  t1.next_2 = t.next$0();
  t3 = new $.XmlParser__parseAttribute_quotesRequired(t, this, t2, t1);
  if (this._withQuirks === true) {
    t4 = t1.next_2;
    t5 = t4.get$kind();
    if (typeof t5 !== 'number')
    ...
    if (t5 === 4)
      t2.call$2(t1.attributeName_1, t4.get$_lib2_str());
    else if (t5 === 9)
      t3.call$0();
  } else
    t3.call$0();
        ...
        switch (state0) {
          ...
          case 4:
            if (state0 === 0 && $.eqB(t4, 4))
              t2.call$2(t1.attributeName_1, t1.next_2.get$_lib2_str());
            else
              switch (state0) {
                case 0:
...
$$.XmlTokenizer = {"":"Object;_specialTags,_lib2_buffer?,_tokenized,_xml?,_lib2_length?,_i?,_lib2_index",
 get$lastTokenIndex: function() {
  return this._lib2_index;
},
 next$0: function() {
  var t1, t2;
  t1 = this._tokenized;
  if ($.CTC1.get$isEmpty(t1) === true)
    return;
  t2 = this._lib2_index;
  if (typeof t2 !== 'number')
    return this.next$0$bailout2(1, t2, t1);
  this._lib2_index = t2 + 1;
  return $.CTC1.removeAt$1(t1, 0);
},
 ...
 indexOfToken$2$start: function(token, start) {
  ...
  if (typeof start !== 'number')
    throw $.iae(start);
  t1 = $.CTC1.getRange$2(t1, start, t2 - start);
  t1 = $.getInterceptor$JSArray(t1).iterator$0(t1);
  i = start;
  for (; t1.get$hasNext() === true;) {
    ...
    if ($.eqB(t2.get$kind(), token.get$kind()))
      if ($.eqB(t2.get$kind(), 4)) {
        if ($.eqB(t2.get$_lib2_str(), token.get$_lib2_str()))
          return i;
 ...
 lookAheadMatch$3$index$until: function(sequence, index, until) {
  ...
  if ($.ltB(index, 0) || $.gtB(index, this._tokenized.length - 1))
    return false;
  t1 = $.add(index, $.getInterceptor$JSStringJSArray(sequence).get$length(sequence));
  t2 = this._tokenized;
  if ($.gtB(t1, t2.length))
    return false;
  t1 = until == null;
 ...
 _sequenceMatch$3: function(sequence, index, until) {
  ...
  if (typeof result !== 'number')
    return this._sequenceMatch$3$bailout(2, sequence, result, until);
  if (result === -1)
    return -1;
  t1 = $.getInterceptor$JSStringJSArray(sequence);
  t2 = sequence.length;
  if (t2 === 1)
    return result;
  return this._sequenceMatch$3(t1.getRange$2(sequence, 1, t2 - 1), result, until);
},
 ...
 _lib2_next$0: function() {
  var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, found, endIndex, m, endComment, nestedTest, endCDATA, endPI, c, _ii, _ii0, s;
  ...
  t7 = this._lib2_buffer;
  if ($.getInterceptor$JSStringJSArray(t7).get$isEmpty(t7) !== true)
    return t2.call$0();
  t7 = this._xml;
  t8 = $.getInterceptor$JSString(t7);
  while (true) {
    if (!($.ltB(this._i, this._lib2_length) && $.geB($.CTC1.indexOf$1($.CTC18, t8.charCodeAt$1(t7, this._i)), 0)))
      break;
    this._i = $.add(this._i, 1);
  }
  if ($.eqB(this._i, this._lib2_length))
    return;
  switch (t8.charCodeAt$1(t7, this._i)) {
    case 33:
      this._i = $.add(this._i, 1);
    ...
    case 47:
      ...
      break;
    case 60:
      for (t9 = this._specialTags, t10 = $.CTC1.iterator$0(t9); found = "", endIndex = -1, t10.get$hasNext() === true;) {
        found = t10.next$0();
        m = t4.call$1(found);
        if (!$.eqB(m, -1)) {
          endIndex = m;
      ...
      $1: {
        ...
        if ($.eqB(t9[0], found)) {
          ...
          t3 = $.getInterceptor$JSStringJSArray(t7);
          endComment = t3.indexOf$2(t7, "-->", this._i);
          nestedTest = t3.indexOf$2(t7, "<!--", this._i);
          if ($.eqB(endComment, -1))
            throw $.$$throw($.CTC19);
          if (!$.eqB(nestedTest, -1) && $.ltB(nestedTest, endComment))
            throw $.$$throw($.CTC20);
          t1.call$1($.XmlToken_XmlToken$string(t8.substring$2(t7, this._i, endComment)));
          ...
          if ($.eqB(t9[1], found)) {
            ...
            this._i = $.add(endIndex, 1);
            t3 = $.getInterceptor$JSStringJSArray(t7);
            endCDATA = t3.indexOf$2(t7, "]]>", this._i);
            nestedTest = t3.indexOf$2(t7, "<![CDATA[", this._i);
            if ($.eqB(endCDATA, -1))
              throw $.$$throw($.CTC21);
            if (!$.eqB(nestedTest, -1) && $.ltB(nestedTest, endCDATA))
              throw $.$$throw($.CTC22);
            t3 = t8.substring$2(t7, this._i, endCDATA);
            t1.call$1($.XmlToken_XmlToken$string($.getInterceptor$JSString(t3).trim$0(t3)));
            ...
            if ($.eqB(t9[2], found)) {
              ...
              this._i = $.add(endIndex, 1);
              t3 = $.getInterceptor$JSStringJSArray(t7);
              endPI = t3.indexOf$2(t7, "?>", this._i);
              nestedTest = t3.indexOf$2(t7, "<?", this._i);
              if ($.eqB(endPI, -1))
                throw $.$$throw($.CTC23);
              if (!$.eqB(nestedTest, -1) && $.ltB(nestedTest, endPI))
                throw $.$$throw($.CTC24);
              t3 = t8.substring$2(t7, this._i, endPI);
              t1.call$1($.XmlToken_XmlToken$string($.getInterceptor$JSString(t3).trim$0(t3)));
              ...
              if ($.eqB(t9[3], found)) {
                ...
                if ($.eqB(c, 32)) {
                  ...
                  t1.call$1($.XmlToken_XmlToken$string(t8.substring$2(t7, _ii, this._i)));
                  this._i = t5.call$1(this._i);
                } else if ($.eqB(c, 58)) {
                  _ii = this._i;
                  this._i = $.add($.getInterceptor$JSStringJSArray(t7).indexOf$2(t7, ":", _ii), 1);
                  t1.call$1($.XmlToken_XmlToken$string(t8.substring$2(t7, _ii, $.sub(this._i, 1))));
                  t1.call$1($.XmlToken_XmlToken(6));
                  _ii0 = t6.call$1(this._i);
                  t1.call$1($.XmlToken_XmlToken$string(t8.substring$2(t7, this._i, _ii0)));
    ...
    default:
      ...
      if (!$.eqB(m, -1)) {
        ...
        s = $.StringBuffer_StringBuffer("");
        t3 = $.getInterceptor$JSArray(s);
        while (true) {
          if (!($.ltB(this._i, this._lib2_length) && !$.gtB($.CTC1.indexOf$1($.CTC25, t8.charCodeAt$1(t7, this._i)), -1)))
            break;
          t4 = this._i;
          t3.add$1(s, t8.substring$2(t7, t4, $.add(t4, 1)));
          this._i = $.add(this._i, 1);
        }
 ...
 get$_lib2_next: function() { return new $.BoundClosure1(this, '_lib2_next$0'); },
 toString$0: function() {
 ...
 XmlTokenizer$1: function(_xml) {
  var t1, t;
  t1 = this._xml;
  this._lib2_length = $.getInterceptor$JSStringJSArray(t1).get$length(t1);
  t = this._lib2_next$0();
...
$$.XmlToken = {"":"Object;kind?,quoteKind?,_lib2_str?,_location=",
 toString$0: function() {
  switch (this.kind) {
    case 16:
      return "(<?)";
    ...
    case 3:
      return "(?)";
    case 4:
      return "STRING(" + $.S(this._lib2_str) + ")";
    case 5:
      return "(!)";
    case 6:
      return "(:)";
...
$$.XmlNode = {"":"Object;type?,parent!",
 remove$0: function() {
  ...
  if (t1 == null)
    return;
  t1 = t1.get$_children();
  i = $.getInterceptor$JSStringJSArray(t1).indexOf$1(t1, this);
  if ($.eqB(i, -1))
    throw $.$$throw($.CTC15);
...
$$.XmlAttribute = {"":"XmlNode;name?,value?,type,parent",
 toString$0: function() {
  var t1, t2, t3;
  t1 = this.value;
  t2 = $.getInterceptor$JSStringJSArray(t1).contains$1(t1, "\"") === true;
  t3 = this.name;
...
$$.XmlException = {"":"Object;msg,debugXml,errorLocation",
 toString$0: function() {
  var t1, s, t2, t3, bLoc, t4, aLoc;
  t1 = this.debugXml;
  if ($.eqB(t1, ""))
    return "Xml Exception: " + $.S(this.msg);
  s = $.StringBuffer_StringBuffer("");
  t2 = $.getInterceptor$JSArray(s);
  t2.add$1(s, "Xml Exception: " + $.S(this.msg));
  t2.add$1(s, "\r");
  t3 = this.errorLocation;
  bLoc = $.ltB(t3, 41) ? 0 : $.sub(t3, 40);
  t4 = $.getInterceptor$JSStringJSArray(t1);
  aLoc = $.gtB(t3, $.sub(t4.get$length(t1), 41)) ? $.sub(t4.get$length(t1), 1) : $.add(t3, 40);
  t2.add$1(s, $.getInterceptor$JSString(t1).substring$2(t1, bLoc, aLoc));
  return t2.toString$0(s);
},
 is$Exception: true
};
...
$$.XmlCollection = {"":"Object;_collection",
 ...
 indexOf$1: function(element) {
  var t1 = this._collection;
  return $.getInterceptor$JSStringJSArray(t1).indexOf$1(t1, element);
},
 operator$index$1: function(index) {
 ...
 _add$1: function(element) {
  var t1 = this._collection;
  return $.getInterceptor$JSArray(t1).add$1(t1, element);
},
 _removeRange$2: function(start, length$) {
  var t1 = this._collection;
  return $.getInterceptor$JSArray(t1).removeRange$2(t1, start, length$);
},
 forEach$1: function(f) {
  var t1 = this._collection;
 ...
 filter$1: function(f) {
  var t1 = this._collection;
  return $.XmlCollection$_from($.getInterceptor$JSArray(t1).filter$1(t1, f));
},
 allElements$0: function() {
  var t1 = this._collection;
  return $.XmlCollection$_from($.getInterceptor$JSArray(t1).filter$1(t1, new $.XmlCollection_allElements_anon()));
},
 some$1: function(f) {
  var t1 = this._collection;
  return $.getInterceptor$JSArray(t1).some$1(t1, f);
 ...
 query$1: function(queryOn) {
  ...
  if (typeof queryOn === 'string')
    for (t1 = this.allElements$0(), t1 = $.getInterceptor$JSArray(t1).iterator$0(t1), t2 = $.getInterceptor$JSStringJSArray(list); t1.get$hasNext() === true;) {
      this._queryNameInternal$3(queryOn, list, t1.next$0());
      if (t2.get$isEmpty(list) !== true)
        break;
    }
  else if (typeof queryOn === 'object' && queryOn !== null && !!queryOn.is$XmlNodeType)
    for (t1 = this.iterator$0(), t2 = $.getInterceptor$JSStringJSArray(list); t1.get$hasNext() === true;) {
 ...
 _queryAttributeInternal$3: function(aMap, list, n) {
  ...
  if (new $.XmlCollection__queryAttributeInternal_checkAttribs(aMap, n).call$0() === true) {
    ...
    $.getInterceptor$JSArray(t1).forEach$1(t1, new $.XmlCollection__queryAttributeInternal_anon(list, aMap));
  }
},
 _queryNodeTypeInternal$3: function(nodeType, list, node) {
  ...
  if ($.eqB(node.get$type(), nodeType)) {
    ...
    $.getInterceptor$JSArray(t1).forEach$1(t1, new $.XmlCollection__queryNodeTypeInternal_anon(list, nodeType));
  }
},
 _queryNameInternal$3: function(tagName, list, element) {
  ...
  if (t1 === tagName) {
    ...
    $.getInterceptor$JSArray(t1).forEach$1(t1, new $.XmlCollection__queryNameInternal_anon(list, tagName));
  }
},
 ...
 queryAll$1: function(queryOn) {
  var list, t1;
  list = $.XmlCollection$_internal();
  for (t1 = this.allElements$0(), t1 = $.getInterceptor$JSArray(t1).iterator$0(t1); t1.get$hasNext() === true;)
 ...
 _queryAllNamesInternal$3: function(tagName, list, element) {
  ...
  if (element.get$hasChildren() === true) {
    ...
    t1 = $.getInterceptor$JSArray(t1).filter$1(t1, new $.XmlCollection__queryAllNamesInternal_anon());
    $.getInterceptor$JSArray(t1).forEach$1(t1, new $.XmlCollection__queryAllNamesInternal_anon0(list, tagName));
  }
},
 ...
 XmlCollection$_from$1: function(list) {
  var t1 = this._collection;
  $.getInterceptor$JSArray(t1).addAll$1(t1, list);
},
 is$Collection: function() { return true; }
};
...
$$.XmlNamespace = {"":"XmlNode;name?,uri,type,parent",
 toString$0: function() {
  ...
  if ($.getInterceptor$JSStringJSArray(t1).get$isEmpty(t1) === true) {
    t2 = this.uri;
    return $.getInterceptor$JSStringJSArray(t2).contains$1(t2, "\"") === true ? " xmlns" + $.S(t1) + "='" + $.S(t2) + "'" : " xmlns" + $.S(t1) + "=\"" + $.S(t2) + "\"";
  }
  t2 = this.uri;
  return $.getInterceptor$JSStringJSArray(t2).contains$1(t2, "\"") === true ? " xmlns:" + $.S(t1) + "='" + $.S(t2) + "'" : " xmlns:" + $.S(t1) + "=\"" + $.S(t2) + "\"";
},
...
$$.ThreeDimensionalObj = {"":"Object;scale?,position=,rotation?",
 ...
 get$transformString: function() {
  ...
  t3 = t1 + $.S($.getInterceptor$JSNumber(t2).toInt$0(t2)) + "px) translateY(";
  t4 = this.position.get$y();
  t5 = t3 + $.S($.getInterceptor$JSNumber(t4).toInt$0(t4)) + "px) translateZ(";
  t6 = this.position.get$z();
  t7 = t5 + $.S($.getInterceptor$JSNumber(t6).toInt$0(t6)) + "px) rotateX(";
  t8 = this.rotation.x;
  t9 = t7 + $.S($.getInterceptor$JSNumber(t8).toInt$0(t8)) + "deg) rotateY(";
  t10 = this.rotation.y;
  t11 = t9 + $.S($.getInterceptor$JSNumber(t10).toInt$0(t10)) + "deg) rotateZ(";
  t12 = this.rotation.z;
  return t11 + $.S($.getInterceptor$JSNumber(t12).toInt$0(t12)) + "deg)";
},
...
$$.Slide = {"":"ThreeDimensionalObj;element?,inFocus!,scale,position,rotation",
 ...
 onGainFocus$2: function(transitionDuration, slideShow) {
  ...
  t1 = t2.get$classes();
  $.getInterceptor$JSArray(t1).add$1(t1, "focused");
 ...
 onLoseFocus$2: function(transitionDuration, slideShow) {
  ...
  t2.get$style().set$transition(t1);
  t1 = t2.get$classes();
  $.getInterceptor$JSArray(t1).add$1(t1, "unfocused");
 ...
 Slide$8: function(element, scale, x, y, z, heading, pitch, roll) {
  ...
  t1 = this.element;
  t2 = t1.get$classes();
  $.getInterceptor$JSArray(t2).add$1(t2, "slide");
  t1 = t1.get$style();
...
$$.Camera = {"":"ThreeDimensionalObj;viewBox,scene?,scale,position,rotation",
 ...
 move$7: function(time, x, y, z, xr, yr, zr) {
  ...
  t3 = "scale(1) translateX(" + $.S($.getInterceptor$JSNumber(t2).toInt$0(t2)) + "px) translateY(";
  t4 = $.add($.neg(y), 0);
  t5 = t3 + $.S($.getInterceptor$JSNumber(t4).toInt$0(t4)) + "px) translateZ(";
  t6 = $.neg(z);
  t7 = t5 + $.S($.getInterceptor$JSNumber(t6).toInt$0(t6)) + "px) rotateZ(" + $.S($.neg($.getInterceptor$JSNumber(zr).toInt$0(zr))) + "deg) rotateY(" + $.S($.neg($.getInterceptor$JSNumber(yr).toInt$0(yr))) + "deg) rotateX(" + $.S($.neg($.getInterceptor$JSNumber(xr).toInt$0(xr))) + "deg)";
  t8 = $.mul(z, 1);
  t9 = $.S($.getInterceptor$JSNumber(t8).toInt$0(t8)) + "px";
  t10 = $.mul(y, 1);
  t11 = $.S($.getInterceptor$JSNumber(t10).toInt$0(t10)) + "px";
  t12 = $.mul(x, 1);
  t13 = $.S($.getInterceptor$JSNumber(t12).toInt$0(t12)) + "px";
  t14 = $.S(time) + "s";
  t1 = t1.get$style();
...
$$.SlideShow = {"":"Object;cam?,useDynamic!",
 ...
 addBackgroundSlide$1: function(slide) {
  ...
  t2 = t1.get$classes();
  $.getInterceptor$JSArray(t2).add$1(t2, "backgroundSlide");
 ...
 onFocus$2: function(slide, transitionDuration) {
  var t1, t2;
  for (t1 = $.CTC1.iterator$0(this.slides); t1.get$hasNext() === true;) {
    t2 = t1.next$0();
    if (!$.eqB(slide, t2))
...
$$.BasicSlideShow = {"":"SlideShow;currentSlideIndex,slides,background,cam,useDynamic",
 ...
 next$0: function() {
  ...
  t2 = this.currentSlideIndex;
  if (typeof t2 !== 'number')
    return this.next$0$bailout3(1, t1, t2);
  this.currentSlideIndex = t2 + 1;
  t2 = this.currentSlideIndex;
  if (typeof t2 !== 'number')
    return this.next$0$bailout3(2, t2, t1);
  if (t2 >= t1.length)
 ...
 next$0$bailout3: function(state0, env0, env1) {
  ...
  switch (state0) {
    ...
    case 1:
      state0 = 0;
      this.currentSlideIndex = $.add(t2, 1);
      t2 = this.currentSlideIndex;
    case 2:
      var t1, t2;
      state0 = 0;
...
$$.onSuccess_anon = {"":"Closure;viewBox_0",
 call$0: function() {
...
$$.XmlParser__parseTextNode_writeStringNode = {"":"Closure;box_0,this_2",
 call$0: function() {
  var t1, t2, string;
  t1 = this.box_0;
  t2 = t1.s_1;
  string = $.getInterceptor(t2).toString$0(t2);
  if ($.getInterceptor$JSStringJSArray(string).get$isEmpty(string) !== true) {
...
$$.XmlNode__stringifyInternal_anon = {"":"Closure;b_0",
 call$2: function(k, v) {
  var t1 = this.b_0;
  return $.getInterceptor$JSArray(t1).add$1(t1, $.XmlNamespace$(k, v).toString$0());
}
};

$$.XmlNode__stringifyInternal_anon0 = {"":"Closure;b_1",
 call$2: function(k, v) {
  var t1 = this.b_1;
  return $.getInterceptor$JSArray(t1).add$1(t1, $.XmlAttribute$(k, v).toString$0());
}
};

$$.XmlCollection__queryNameInternal_anon = {"":"Closure;list_1,tagName_0",
 call$1: function(el) {
  var t1 = this.list_1;
  if ($.getInterceptor$JSStringJSArray(t1).get$isEmpty(t1) !== true)
    return;
...
$$.XmlElement__queryNameInternal_anon = {"":"Closure;list_1,tagName_0",
 call$1: function(el) {
  var t1 = this.list_1;
  if ($.getInterceptor$JSStringJSArray(t1).get$isEmpty(t1) !== true)
    return;
...
$$.XmlCollection_allElements_anon = {"":"Closure;",
 call$1: function(n) {
  return typeof n === 'object' && n !== null && !!n.is$XmlElement;
}
};

$$.XmlElement_addChildren_anon = {"":"Closure;this_0",
 call$1: function(e) {
...
$$.XmlTokenizer__next_addToQueue = {"":"Closure;this_0",
 call$1: function(token) {
  ...
  t1 = t1.get$_lib2_buffer();
  $.getInterceptor$JSArray(t1).addLast$1(t1, token);
}
};
...
$$.XmlTokenizer__next_getNextToken = {"":"Closure;this_1",
 call$0: function() {
  var t1, t2;
  t1 = this.this_1;
  t2 = t1.get$_lib2_buffer();
  return $.getInterceptor$JSStringJSArray(t2).get$isEmpty(t2) === true ? null : t1.get$_lib2_buffer().removeFirst$0();
}
};
...
$$.XmlTokenizer__next_peekUntil = {"":"Closure;this_2",
 call$1: function(chars) {
  ...
  for (; t2 = $.getInterceptor$JSStringJSArray(chars), t3 = t1.get$_xml(), $.eqB(t2.indexOf$1(chars, $.getInterceptor$JSString(t3).charCodeAt$1(t3, z)), -1);) {
    ++z;
    if ($.geB(z, t1.get$_lib2_length()))
      break;
  }
  if ($.geB(z, t1.get$_lib2_length()))
    return -1;
  t1 = t1.get$_xml();
  return $.getInterceptor$JSString(t1).charCodeAt$1(t1, z);
},
...
$$.XmlTokenizer__next_matchWord = {"":"Closure;this_3",
 call$1: function(word) {
  ...
  for (t2 = $.getInterceptor$JSStringJSArray(word), ii = 0; $.ltB(ii, t2.get$length(word)); ++ii) {
    t3 = t1.get$_xml();
    if (!$.eqB($.getInterceptor$JSString(t3).charCodeAt$1(t3, z), t2.charCodeAt$1(word, ii)))
      return -1;
    ++z;
  }
  return z - 1;
...
$$.XmlTokenizer__next_nextNonWhitespace = {"":"Closure;this_4",
 call$1: function(from) {
  ...
  for (; t1 = this.this_4.get$_xml(), $.geB($.CTC1.indexOf$1($.CTC18, $.getInterceptor$JSString(t1).charCodeAt$1(t1, from)), 0);)
    ++from;
  return from;
},
...
$$.XmlTokenizer__next_nextWhitespace = {"":"Closure;this_5",
 call$1: function(from) {
  ...
  for (; t1 = this.this_5.get$_xml(), !$.geB($.CTC1.indexOf$1($.CTC18, $.getInterceptor$JSString(t1).charCodeAt$1(t1, from)), 0);)
    ++from;
  return from;
},
...
$$.XmlParser__parseAttribute_setAttribute = {"":"Closure;el_3",
...
$$.XmlParser__parseAttribute_quotesRequired = {"":"Closure;t_6,this_5,setAttribute_4,box_0",
 call$0: function() {
  var t1, t2, s, qkind, t3;
  t1 = this.this_5;
  t2 = this.box_0;
  ...
  do {
    ...
    if (!$.eqB(t1.get$kind(), 9))
      t3.add$1(s, t2.next_2.toStringLiteral$0());
    else if (!$.eqB(t2.next_2.get$quoteKind(), qkind))
      t3.add$1(s, t2.next_2.toStringLiteral$0());
    else
      qkind = -1;
  } while (!(qkind === -1));
  this.setAttribute_4.call$2(t2.attributeName_1, t3.toString$0(s));
},
 call$0$bailout: function(state0, s, t2, qkind) {
  ...
  this.setAttribute_4.call$2(t2.attributeName_1, $.getInterceptor(s).toString$0(s));
}
};
...
$$.XmlParser__parseNamespace_setNamespace = {"":"Closure;el_2",
 call$2: function(name$, uri) {
  $.indexSet(this.el_2.get$namespaces(), name$, uri);
}
};

$$.XmlParser__parseNamespace_quotesRequired = {"":"Closure;name_6,box_0,setNamespace_5,t_4,this_3",
 call$0: function() {
  var t1, t2, s, qkind, t3;
  t1 = this.this_3;
  t2 = this.box_0;
  ...
  do {
    ...
    if (t1 == null)
      throw $.$$throw($.CTC8);
    if (!$.eqB(t1.get$kind(), 9))
      t3.add$1(s, t2.next_1.toStringLiteral$0());
    else if (!$.eqB(t2.next_1.get$quoteKind(), qkind))
      t3.add$1(s, t2.next_1.toStringLiteral$0());
    else
      qkind = -1;
  } while (!(qkind === -1));
  this.setNamespace_5.call$2(this.name_6, t3.toString$0(s));
},
 call$0$bailout0: function(state0, s, t2, qkind) {
  ...
  this.setNamespace_5.call$2(this.name_6, $.getInterceptor(s).toString$0(s));
}
};

$$.XmlElement_isNamespaceInScope_anon = {"":"Closure;namespace_0",
 call$1: function(ns) {
...
$$.XmlElement_namespacesInScope_anon = {"":"Closure;l_0",
 call$2: function(nname, uri) {
  var t1 = this.l_0;
  $.getInterceptor$JSArray(t1).add$1(t1, $.XmlNamespace$(nname, uri));
}
};

$$.XmlCollection__queryAttributeInternal_checkAttribs = {"":"Closure;aMap_3,n_2",
 call$0: function() {
  var t1, t2;
  t1 = {};
  t1.succeed_10 = true;
  t2 = this.aMap_3;
  $.getInterceptor$JSArray(t2).forEach$1(t2, new $.XmlCollection__queryAttributeInternal_checkAttribs_anon(this.n_2, t1));
  return t1.succeed_10;
}
};

$$.XmlCollection__queryAttributeInternal_checkAttribs_anon = {"":"Closure;n_4,box_0",
 call$2: function(k, v) {
  var t1 = this.box_0;
...
$$.XmlCollection__queryAttributeInternal_anon = {"":"Closure;list_6,aMap_5",
 call$1: function(el) {
  var t1 = this.list_6;
  if ($.getInterceptor$JSStringJSArray(t1).get$isEmpty(t1) !== true)
    return;
  $.propertyTypeCast(el, 'is$XmlElement')._queryAttributeInternal$2(this.aMap_5, t1);
}
};

$$.XmlElement__queryAttributeInternal_checkAttribs = {"":"Closure;aMap_3,this_2",
 call$0: function() {
  var t1, t2;
  t1 = {};
  t1.succeed_1 = true;
  t2 = this.aMap_3;
  $.getInterceptor$JSArray(t2).forEach$1(t2, new $.XmlElement__queryAttributeInternal_checkAttribs_anon(t1, this.this_2));
  return t1.succeed_1;
}
};

$$.XmlElement__queryAttributeInternal_checkAttribs_anon = {"":"Closure;box_0,this_4",
 call$2: function(k, v) {
  var t1 = this.box_0;
...
$$.XmlElement__queryAttributeInternal_anon = {"":"Closure;list_6,aMap_5",
 call$1: function(el) {
  var t1 = this.list_6;
  if ($.getInterceptor$JSStringJSArray(t1).get$isEmpty(t1) !== true)
    return;
...
$$.XmlCollection__queryNodeTypeInternal_anon = {"":"Closure;list_1,nodeType_0",
 call$1: function(el) {
  var t1 = this.list_1;
  if ($.getInterceptor$JSStringJSArray(t1).get$isEmpty(t1) !== true)
    return;
...
$$.XmlElement__queryNodeTypeInternal_anon = {"":"Closure;list_1,nodeType_0",
 call$1: function(el) {
  var t1 = this.list_1;
  if ($.getInterceptor$JSStringJSArray(t1).get$isEmpty(t1) !== true)
    return;
...
$$.SingleSelect__makeButton_anon = {"":"Closure;number_1,this_0",
 call$1: function(event$) {
  return this.this_0.setAnswer$1(this.number_1);
}
};

$$.MultipleSelect__makeButton_anon = {"":"Closure;number_1,this_0",
 call$1: function(event$) {
  return this.this_0.toggleAnswer$1(this.number_1);
}
};

$$.Storage_containsValue_anon = {"":"Closure;value_0",
 call$1: function(e) {
...
$$._LinkedHashMapImpl_containsValue_anon = {"":"Closure;value_0",
 call$1: function(entry) {
  return $.eq(entry.get$value(), this.value_0);
}
};

$$.ConstantMap_containsValue_anon = {"":"Closure;needle_0",
 call$1: function(value) {
...
$$.XmlElement__queryAllNamesInternal_anon = {"":"Closure;",
 call$1: function(el) {
  return typeof el === 'object' && el !== null && !!el.is$XmlElement;
}
};

$$.XmlElement__queryAllNamesInternal_anon0 = {"":"Closure;list_1,tagName_0",
 call$1: function(el) {
  el._queryAllNamesInternal$2(this.tagName_0, this.list_1);
}
};

$$.XmlCollection__queryAllNamesInternal_anon = {"":"Closure;",
 call$1: function(el) {
  return typeof el === 'object' && el !== null && !!el.is$XmlElement;
}
};

$$.XmlCollection__queryAllNamesInternal_anon0 = {"":"Closure;list_1,tagName_0",
 call$1: function(el) {
  el._queryAllNamesInternal$2(this.tagName_0, this.list_1);
}
};

$$.XmlElement_text_anon = {"":"Closure;",
 call$1: function(el) {
  return typeof el === 'object' && el !== null && !!el.is$XmlText;
}
};

$$.XmlElement_text_anon0 = {"":"Closure;s_0",
 call$1: function(n) {
  var t1 = this.s_0;
  return $.getInterceptor$JSArray(t1).add$1(t1, n.get$text());
}
};

$$.addSplash_anon = {"":"Closure;",
 call$1: function(event$) {
  return $.startTest();
}
};

$$.startTest_anon = {"":"Closure;",
 call$0: function() {
  $.nextQuestion();
  $.scriptButton();
}
...
$$.scriptButton_anon2 = {"":"Closure;",
 call$1: function(event$) {
  var finalSection, buttonContent, button, slide;
  $.hideButtons();
  ...
  $.saveFinalSummary();
  buttonContent.appendHtml$1("<a href='report.html'><img src='images/badge.png' alt='Agile Fluency Assessment Report'/></a>");
...
$$.getStamp_anon = {"":"Closure;number_1,stampContainer_0",
 call$0: function() {
  var t1 = "stamp" + $.S(this.number_1) + "Show";
  this.stampContainer_0.set$id(t1);
}
};
...
$$.saveFinalSummary_anon = {"":"Closure;req_0",
 call$1: function(e) {
  var theId, buttonUrl, buttonLink;
  theId = this.req_0.get$responseText();
  buttonUrl = $.query(".buttonUrl");
  buttonLink = $.query("#buttonLink");
  buttonUrl.insertAdjacentText$2("afterBegin", "<a href='http://" + $.S($._serverAddress) + ":" + $.S($._serverPort) + "/report.html?id=" + $.S(theId) + "'><img src='http://labs.catalystsolves.com/Projects/AgileFluency/images/badge.png' alt='Agile Fluency Assessment Report'/></a>");
...
$$.Answer_explain_anon = {"":"Closure;output_1,this_0",
 call$1: function(event$) {
...
$$.Answer_explain_anon0 = {"":"Closure;output_3,answerText_2",
 call$1: function(event$) {
...
$$.Answer_explain_anon1 = {"":"Closure;output_5,this_4",
 call$1: function(event$) {
  return this.output_5.insertAdjacentHTML$2("beforeEnd", "<b>" + $.S(this.this_4.get$explanation()) + "</b>");
}
};

$$.Answer_explain_anon2 = {"":"Closure;output_7,answerText_6",
 call$1: function(event$) {
...
$$.Answer_toggleListener_anon = {"":"Closure;this_2,button_1,modal_0",
 call$1: function(event$) {
  return this.this_2.showModal$2(this.button_1, this.modal_0);
}
};

$$.Answer_toggleListener_anon0 = {"":"Closure;this_5,button_4,modal_3",
 call$1: function(event$) {
  return this.this_5.hideModal$2(this.button_4, this.modal_3);
}
};

$$.Answer_toggleListener_anon1 = {"":"Closure;this_8,button_7,modal_6",
 call$1: function(event$) {
  return this.this_8.toggleListener$3(3, this.button_7, this.modal_6);
}
};
...
$$._WorkerSendPort_send_anon = {"":"Closure;message_2,this_1,replyTo_0",
 call$0: function() {
...
$.stringContainsUnchecked = function(receiver, other, startIndex) {
  var substr, t1;
  if (typeof other === 'string')
    return !$.eqB($.CTC0.indexOf$2(receiver, other, startIndex), -1);
  else if (typeof other === 'object' && other !== null && !!other.is$JSSyntaxRegExp)
    return other.hasMatch$1($.CTC0.substring$1(receiver, startIndex));
  else {
    substr = $.CTC0.substring$1(receiver, startIndex);
...
$.dynamicFunction = function(name$) {
  ...
  if (!(f == null) && !!f.methods)
    return f.methods;
  methods = {};
  dartMethod = Object.getPrototypeOf($.CTC31)[name$];
  if (!(dartMethod == null))
...
$.nextQuestion = function() {
  var slideElement, today, t1, stampsDiv, stamp;
  slideElement = $.get$test().next$0();
  today = $.Date_Date$now();
  $.hideButtons();
  t1 = slideElement.get$id();
  if ($.getInterceptor$JSString(t1).startsWith$1(t1, "summary") === true) {
    $.enableSummaryButtons();
    stampsDiv = slideElement.query$1("#stampsDiv" + $.S($.get$test().get$currentSection().get$star()));
    for (t1 = $.get$stampsEarned(), t1 = $.getInterceptor$JSArray(t1).iterator$0(t1); t1.get$hasNext() === true;)
      stampsDiv.insertAdjacentElement$2("beforeEnd", t1.next$0());
    if ($.checkSectionFluency()) {
      stampsDiv.insertAdjacentElement$2("beforeEnd", $.getStamp($.get$test().get$currentSection().get$star(), false, $.formatTheDate(today)));
      stamp = $.getStamp($.get$test().get$currentSection().get$star(), true, $.formatTheDate(today));
      t1 = $.get$stampsEarned();
      $.getInterceptor$JSArray(t1).add$1(t1, stamp);
    }
  }
...
$.formatTheDate = function(theDate) {
  var mon, day;
  mon = $.ltB(theDate.get$month(), 10) ? "0" + $.S(theDate.get$month()) : $.S(theDate.get$month());
  day = $.ltB(theDate.get$day(), 10) ? "0" + $.S(theDate.get$day()) : $.S(theDate.get$day());
  return mon + "/" + day + "/" + $.S(theDate.get$year());
};
...
$.saveFinalSummary = function() {
  ...
  for (aSection = null, i = 0; t1 = $.get$test().get$sections(), $.ltB(i, $.getInterceptor$JSStringJSArray(t1).get$length(t1)); ++i)
    if ($.index($.get$test().get$sections(), i).get$done() === true) {
      aSection = $.Map_Map();
      $.indexSet(aSection, "section", $.index($.get$test().get$sections(), i).get$star());
      $.indexSet(aSection, "fluency", $.index($.get$test().get$sections(), i).get$finalPercentage());
      $.indexSet(aSection, "totalAgile", $.index($.get$test().get$sections(), i).get$finalTotalAns());
      $.indexSet(aSection, "mostAgile", $.index($.get$test().get$sections(), i).get$finalFluentAns());
      $.indexSet(aSection, "name", $.index($.get$test().get$sections(), i).get$name());
      sectionList.push(aSection);
    }
  $.indexSet(assessmentRun, "stampList", sectionList);
  jsonString = $.JSON_stringify(assessmentRun);
  req = $.HttpRequest_HttpRequest();
  t1 = req.get$on().get$load();
  $.getInterceptor$JSArray(t1).add$1(t1, new $.saveFinalSummary_anon(req));
  req.open$2("POST", "http://" + $.S($._serverAddress) + ":" + $.S($._serverPort) + "/persist");
  req.send$1(jsonString);
};
...
$.onSuccess = function(request) {
  ...
  for (i = 1; i < 5; ++i) {
    ...
    $.getInterceptor$JSArray(t1).add$1(t1, $.TestSection$(i, request.get$responseText()));
  }
...
$.addSplash = function() {
  ...
  $.getInterceptor$JSArray(t1).add$1(t1, new $.addSplash_anon());
  $.get$slideshow().start$0();
};

$.scriptButton = function() {
  var t1 = $.query("#nextButton").get$on().get$click();
  $.getInterceptor$JSArray(t1).add$1(t1, new $.scriptButton_anon());
  t1 = $.get$explainButton().get$on().get$click();
  $.getInterceptor$JSArray(t1).add$1(t1, new $.scriptButton_anon0());
  t1 = $.get$backButton().get$on().get$click();
  $.getInterceptor$JSArray(t1).add$1(t1, new $.scriptButton_anon1());
  t1 = $.get$finishButton().get$on().get$click();
  $.getInterceptor$JSArray(t1).add$1(t1, new $.scriptButton_anon2());
};
...
$.enableSummaryButtons = function() {
  ...
  if (!$.eqB(t1, $.getInterceptor$JSArray(t2).get$last(t2)))
...
$._ElementFactoryProvider_createElement_html = function(html) {
  ...
  if (!(match == null)) {
    ...
    parentTag = $.CTC29.containsKey$1(tag) === true ? $.CTC29.operator$index$1(tag) : "div";
  } else {
    parentTag = "div";
    tag = null;
  }
    ...
    if (typeof b === 'number') {
      ...
      if (typeof b === 'number') {
        if (typeof a === 'number')
          if (a === 0)
            return (a + b) * a * b;
        if (a === 0 && $.CTC30.get$isNegative(b) === true || $.CTC30.get$isNaN(b) === true)
          return b;
        return a;
      }
      return a;
...
$.XML_parse = function(xml, withQuirks) {
  return $.XmlParser__parse($.getInterceptor$JSString(xml).trim$0(xml), withQuirks);
};
...
$.TestSection$ = function(level, xml) {
  var t1 = new $.TestSection(null, null, null, null, null, null, null, false, false, false, false, false, "0", "0/0", "0/0");
...
$.XmlParser__parse = function(xml, withQuirks) {
  var p;
  if ($.getInterceptor$JSStringJSArray(xml).get$isEmpty(xml) === true)
    throw $.$$throw($.CTC5);
...
$.XmlElement$ = function(name$, elements) {
  var t1 = new $.XmlElement(name$, $.XmlCollection$_internal(), $.makeLiteralMap([]), $.makeLiteralMap([]), $.CTC9, null);
...
$.XmlNode__space = function(amount) {
  ...
  s = $.StringBuffer_StringBuffer("");
  for (t1 = $.getInterceptor$JSArray(s), i = 0; i < amount; ++i)
    t1.add$1(s, " ");
  return t1.toString$0(s);
};

$.XmlNode__stringifyInternal = function(b, n, indent, leadingWhiteSpace) {
  var t1, t2, i, whitespace, t3;
  t1 = n.get$type();
  switch (t1) {
    case $.CTC9:
      $.propertyTypeCast(n, 'is$XmlElement');
      if (leadingWhiteSpace === true)
        $.getInterceptor$JSArray(b).add$1(b, "\r" + $.S($.XmlNode__space(indent)));
      t1 = $.getInterceptor$JSArray(b);
      t1.add$1(b, "<" + $.S(n.get$name()));
      t2 = n.get$namespaces();
      if ($.gtB($.getInterceptor$JSStringJSArray(t2).get$length(t2), 0)) {
        t2 = n.get$namespaces();
        $.getInterceptor$JSArray(t2).forEach$1(t2, new $.XmlNode__stringifyInternal_anon(b));
      }
      t2 = n.get$attributes();
      if ($.gtB($.getInterceptor$JSStringJSArray(t2).get$length(t2), 0)) {
        t2 = n.get$attributes();
        $.getInterceptor$JSArray(t2).forEach$1(t2, new $.XmlNode__stringifyInternal_anon0(b));
      }
      t1.add$1(b, ">");
      if (n.get$hasChildren() === true)
        for (i = 0; t2 = n.get$children(), $.ltB(i, $.getInterceptor$JSStringJSArray(t2).get$length(t2)); ++i) {
          whitespace = !(i > 0 && $.eqB($.index(n.get$children(), i - 1).get$type(), $.CTC10));
          $.XmlNode__stringifyInternal(b, $.index(n.get$children(), i), $.add(indent, 3), whitespace);
        }
      t2 = n.get$children();
      if ($.gtB($.getInterceptor$JSStringJSArray(t2).get$length(t2), 0)) {
        t2 = n.get$children();
        t3 = !$.eqB($.getInterceptor$JSArray(t2).get$last(t2).get$type(), $.CTC10);
        t2 = t3;
      } else
        t2 = false;
      if (t2)
        t1.add$1(b, "\r" + $.S($.XmlNode__space(indent)) + "</" + $.S(n.get$name()) + ">");
      else
        t1.add$1(b, "</" + $.S(n.get$name()) + ">");
      break;
    case $.CTC11:
    case $.CTC12:
      $.getInterceptor$JSArray(b).add$1(b, $.getInterceptor(n).toString$0(n));
      break;
    case $.CTC10:
      $.getInterceptor$JSArray(b).add$1(b, $.S(n));
      break;
    case $.CTC13:
    case $.CTC14:
      $.getInterceptor$JSArray(b).add$1(b, "\r" + $.S(n));
      break;
    default:
...
$.XmlTokenizer$ = function(_xml) {
  var t1 = new $.XmlTokenizer($.CTC17, $.Queue_Queue(), $.List_List(null), _xml, null, 0, -1);
...
$.XmlText$ = function(text) {
  return new $.XmlText(text, $.CTC10, null);
};
...
$.XmlNamespace$ = function(name$, uri) {
  return new $.XmlNamespace(name$, uri, $.CTC11, null);
};

$.XmlAttribute$ = function(name$, value) {
  return new $.XmlAttribute(name$, value, $.CTC12, null);
};
...
$.XmlProcessingInstruction$ = function(text) {
  return new $.XmlProcessingInstruction(text, $.CTC13, null);
};

$.XmlCDATA$ = function(text) {
  return new $.XmlCDATA(text, $.CTC14, null);
};
...
$.XmlNode__space$bailout = function(state0, amount) {
  var s, t1, i;
  s = $.StringBuffer_StringBuffer("");
  for (t1 = $.getInterceptor$JSArray(s), i = 0; $.ltB(i, amount); ++i)
    t1.add$1(s, " ");
  return $.getInterceptor(s).toString$0(s);
};
...
$.CTC20 = new Isolate.$isolateProperties.XmlException("Nested comments not allowed.", "", 0);
$.CTC30 = new Isolate.$isolateProperties.JSDouble();
$.CTC24 = new Isolate.$isolateProperties.XmlException("Nested PI not allowed.", "", 0);
$.CTC21 = new Isolate.$isolateProperties.XmlException("End CDATA tag not found.", "", 0);
$.CTC14 = new Isolate.$isolateProperties.XmlNodeType("CDATA");
$.CTC4 = new Isolate.$isolateProperties._DeletedKeySentinel();
$.CTC11 = new Isolate.$isolateProperties.XmlNodeType("Namespace");
$.CTC12 = new Isolate.$isolateProperties.XmlNodeType("Attribute");
$.CTC9 = new Isolate.$isolateProperties.XmlNodeType("Element");
$.CTC13 = new Isolate.$isolateProperties.XmlNodeType("PI");
$.CTC25 = Isolate.makeConstantList([60, 62, 33, 58, 47, 34, 39, 61]);
$.CTC22 = new Isolate.$isolateProperties.XmlException("Nested CDATA not allowed.", "", 0);
$.CTC7 = new Isolate.$isolateProperties.XmlException("Unexpected end of file.  Not all tags were closed.", "", 0);
$.CTC15 = new Isolate.$isolateProperties.XmlException("Element not found.", "", 0);
$.CTC28 = new Isolate.$isolateProperties.XmlException("CDATA nodes are not supported in the top level.", "", 0);
$.CTC32 = Isolate.makeConstantList(["body", "head", "caption", "td", "colgroup", "col", "tr", "tbody", "tfoot", "thead", "track"]);
$.CTC29 = new Isolate.$isolateProperties.ConstantMap(11, {body: "html", head: "html", caption: "table", td: "tr", colgroup: "table", col: "colgroup", tr: "tbody", tbody: "table", tfoot: "table", thead: "table", track: "audio"}, Isolate.$isolateProperties.CTC32);
$.CTC26 = new Isolate.$isolateProperties.ConstantMap(0, {}, Isolate.$isolateProperties.CTC16);
$.CTC27 = new Isolate.$isolateProperties.XmlException("PI nodes are not supported in the top level.", "", 0);
$.CTC23 = new Isolate.$isolateProperties.XmlException("End PI tag not found.", "", 0);
$.CTC31 = new Isolate.$isolateProperties.Object();
$.CTC17 = Isolate.makeConstantList(["<!--", "<![CDATA[", "<?", "</"]);
$.CTC = new Isolate.$isolateProperties.NullThrownError();
$.CTC6 = new Isolate.$isolateProperties.XmlException("Text not allowed in root level. Use comments instead.", "", 0);
$.CTC18 = Isolate.makeConstantList([32, 9, 10, 13]);
$.CTC5 = new Isolate.$isolateProperties.XmlException("Nothing to parse.", "", 0);
$.CTC8 = new Isolate.$isolateProperties.XmlException("Unexpected end of file.", "", 0);
$.CTC10 = new Isolate.$isolateProperties.XmlNodeType("Text");
$.CTC19 = new Isolate.$isolateProperties.XmlException("End comment tag not found.", "", 0);
...
$.XmlTokenizer__reserved = Isolate.$isolateProperties.CTC25;
$.XmlTokenizer__whiteSpace = Isolate.$isolateProperties.CTC18;
...
$.XmlNodeType_Element = Isolate.$isolateProperties.CTC9;
$.XmlNodeType_Attribute = Isolate.$isolateProperties.CTC12;
$.XmlNodeType_Text = Isolate.$isolateProperties.CTC10;
$.XmlNodeType_Namespace = Isolate.$isolateProperties.CTC11;
$.XmlNodeType_CDATA = Isolate.$isolateProperties.CTC14;
$.XmlNodeType_PI = Isolate.$isolateProperties.CTC13;
...
$.$defineNativeClass('Document', {"":"readyState?",
 ...
 queryAll$1: function(selectors) {
  ...
  if ($.RegExp_RegExp("^\\[name=[\"'][^'\"]+['\"]\\]$", false, false).hasMatch$1(selectors) === true) {
    mutableMatches = this.$dom_getElementsByName$1($.CTC0.substring$2(selectors, 7, selectors.length - 2));
...
$.$defineNativeClass('DocumentFragment', {
 get$_lib3_children: function() { return this._children; },
 ...
 _insertAdjacentNode$2: function(where, node) {
  var t1;
  switch ($.CTC0.toLowerCase$0(where)) {
    case "beforebegin":
      return;
    case "afterend":
      return;
...
$.$defineNativeClass('DOMWindow', {"":"name?,navigator?,status?",
 ...
 set$_lib3_location: function(value) {
  this.location = value;
},
 get$on: function() {
...
$.$defineNativeClass('Storage', {
 containsValue$1: function(value) {
  var t1 = this.get$values();
  return $.getInterceptor$JSArray(t1).some$1(t1, new $.Storage_containsValue_anon(value));
},
 containsKey$1: function(key) {
