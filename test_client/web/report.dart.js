...
$$.SlideShow = {"":"Object;cam?",
 ...
 onFocus$2: function(slide, transitionDuration) {
  var t1, t2;
  for (t1 = $.CTC0.iterator$0(this.slides); t1.get$hasNext() === true;) {
    t2 = t1.next$0();
    if (!$.eqB(slide, t2))
...
$$.BasicSlideShow = {"":"SlideShow;currentSlideIndex,slides,background,cam,useDynamic",
 ...
 next$0: function() {
  ...
  t2 = this.currentSlideIndex;
  if (typeof t2 !== 'number')
    return this.next$0$bailout1(1, t1, t2);
...
$$.displayResults_anon = {"":"Closure;jsonResults_0",
 call$0: function() {
  $.addSummary(this.jsonResults_0);
}
};

$$.getStamp_anon = {"":"Closure;stampContainer_1,number_0",
 call$0: function() {
...
$$.getUriParams_anon = {"":"Closure;paramMapping_0",
 call$1: function(e) {
  ...
  t2 = t1.contains$1(e, "=") === true;
  t3 = this.paramMapping_0;
  if (t2) {
    paramValue = t1.split$1(e, "=");
    $.indexSet(t3, $.index(paramValue, 0), $.index(paramValue, 1));
  } else
    $.indexSet(t3, e, "");
}
};
...
$.stripNameHtml = function(theName) {
  var t1 = $.getInterceptor$JSStringJSArray(theName);
  return t1.substring$2(theName, $.add(t1.indexOf$1(theName, "<name>"), 6), t1.indexOf$1(theName, "</name>"));
};

$.addSummary = function(jsonResults) {
  var output, stampsDiv, t1, passport, passportBottomLeftDiv, passportBottomRightDiv, content$, theDate, sectionList, i, Fluency, TotalAgile, MostAgile, fluencyInt, sectionInt, slide;
  ...
  passportBottomLeftDiv = $.DivElement_DivElement();
  passportBottomLeftDiv.set$id("passportBottomLeftDiv");
  t1 = passportBottomLeftDiv.get$classes();
  $.getInterceptor$JSArray(t1).add$1(t1, "passportBottomLeftDiv");
  output.insertAdjacentElement$2("beforeEnd", passportBottomLeftDiv);
  passportBottomLeftDiv.appendHtml$1("Results from an <b>Agile Fluency Assessment</b>.<br /><br />Read more about it at <a href='http://labs.catalystsolves.com/?q=AgileFluency'>our blog</a>.");
  passportBottomRightDiv = $.DivElement_DivElement();
  passportBottomRightDiv.set$id("passportBottomRightDiv");
  t1 = passportBottomRightDiv.get$classes();
  $.getInterceptor$JSArray(t1).add$1(t1, "passportBottomRightDiv");
  output.insertAdjacentElement$2("beforeEnd", passportBottomRightDiv);
  ...
  content$.appendHtml$1("<h4>Date of assessment: " + $.S(theDate) + "</h4><br />");
  ...
  if (typeof sectionList !== 'string' && (typeof sectionList !== 'object' || sectionList === null || sectionList.constructor !== Array && !sectionList.is$JavaScriptIndexingBehavior()))
    return $.addSummary$bailout(1, theDate, sectionList, content$, output, stampsDiv);
  for (i = 0; i < sectionList.length; ++i) {
    ...
    if (i >= sectionList.length)
      throw $.ioore(i);
    content$.appendHtml$1("<h4>" + $.S($.stripNameHtml($.index(sectionList[i], "name"))) + " : " + $.S(Fluency) + "%</h4>");
    content$.appendHtml$1("<li>Total Agile Answers: " + $.S(TotalAgile) + "</li>");
    content$.appendHtml$1("<li>Most Fluent Answers: " + $.S(MostAgile) + "</li></ul>");
    if (i !== sectionList.length - 1)
      content$.appendHtml$1("<hr />");
  }
...
$.main = function() {
  ...
  if (!(hexstring == null)) {
    ...
    $.getInterceptor$JSArray(t1).add$1(t1, new $.main_anon(req));
...
$.getUriParams = function(uriSearch) {
  ...
  if (!$.eqB(uriSearch, "")) {
    t1 = $.getInterceptor$JSString(uriSearch).substring$1(uriSearch, 1);
    paramValuePairs = $.getInterceptor$JSString(t1).split$1(t1, "&");
    paramMapping = $.HashMap_HashMap();
    $.getInterceptor$JSArray(paramValuePairs).forEach$1(paramValuePairs, new $.getUriParams_anon(paramMapping));
    return paramMapping;
  }
};
...
$.addSummary$bailout = function(state0, theDate, sectionList, content$, output, stampsDiv) {
  var t1, i, Fluency, TotalAgile, MostAgile, fluencyInt, sectionInt, slide;
  for (t1 = $.getInterceptor$JSStringJSArray(sectionList), i = 0; $.ltB(i, t1.get$length(sectionList)); ++i) {
    ...
    content$.appendHtml$1("<h4>" + $.S($.stripNameHtml($.index($.index(sectionList, i), "name"))) + " : " + $.S(Fluency) + "%</h4>");
    content$.appendHtml$1("<li>Total Agile Answers: " + $.S(TotalAgile) + "</li>");
    content$.appendHtml$1("<li>Most Fluent Answers: " + $.S(MostAgile) + "</li></ul>");
    if (!(i === $.sub(t1.get$length(sectionList), 1)))
      content$.appendHtml$1("<hr />");
  }
  output.insertAdjacentElement$2("beforeEnd", content$);
  for (i = 0; $.ltB(i, t1.get$length(sectionList)); ++i) {
...
$.$defineNativeClass('HTMLAnchorElement', {"":"search?",
 toString$0: function() {
...
$.$defineNativeClass('DocumentFragment', {
 ...
 _insertAdjacentNode$2: function(where, node) {
  var t1;
  switch ($.CTC4.toLowerCase$0(where)) {
    case "beforebegin":
      return;
    case "afterend":
      return;
...
$.$defineNativeClass('HTMLFrameElement', {"":"location?,src!",
 is$Element: function() { return true; }
});
